...
\end{equation*}
由于\(\vb{P}\)是可逆矩阵，
所以\(\DeterminantA{\vb{P}} = \frac12 k_1^3 \neq 0\)，
...
两端取行列式，得\begin{equation*}
	\DeterminantA{\vb{B}} = \DeterminantA{\vb{P}^{-1}\vb{A}\vb{P}}
	= \DeterminantA{\vb{P}^{-1}}\DeterminantA{\vb{A}}\DeterminantA{\vb{P}}
	= \DeterminantA{\vb{P}}^{-1}\DeterminantA{\vb{A}}\DeterminantA{\vb{P}}
	= \DeterminantA{\vb{A}}.
	\qedhere
\end{equation*}
...
于是\begin{equation*}
	...
	=\DeterminantA{\vb{P}^{-1}(\lambda\vb{E}-\vb{A})\vb{P}}
	=\DeterminantA{\vb{P}^{-1}}\DeterminantA{\lambda\vb{E}-\vb{A}}\DeterminantA{\vb{P}}
...
\end{example}
\begin{example}
%@see: 《高等代数》（丁南庆、刘公祥、纪庆忠、郭学军） P151 习题2 57.(3)
设\(\vb{A} \in M_n(K)\)，
且\(\rank\vb{A} = r\)，
则\(\vb{A}\)是幂等矩阵，
当且仅当存在可逆矩阵\(\vb{P}\)，
