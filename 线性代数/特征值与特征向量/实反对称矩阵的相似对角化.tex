...
\begin{theorem}
%@see: 《Multiple View Geometry in Computer Vision Second Edition》（Richard Hartley, Andrew Zisserman） P580 Result A4.1 Eigenvalue decomposition
设\(\vb{A}\)是\(n\)阶实反对称矩阵，
则存在正交矩阵\(\vb{Q}\)，
使得\(\vb{A} = \vb{Q} \vb{B} \vb{Q}^T\)，
其中\(\vb{B}\)是形如\(
	\diag(
		a_1 \vb{Z},
		a_2 \vb{Z},
