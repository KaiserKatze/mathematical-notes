...
%@see: 《Linear Algebra Done Right (Fourth Eidition)》（Sheldon Axler） P18 1.33
设\(V\)是域\(F\)上的一个线性空间，
\(\emptyset\neq U\subseteq V\).
...
显然\(\{0\}\)是\(V\)的一个子空间，
%@see: 《Linear Algebra Done Right (Fourth Eidition)》（Sheldon Axler） P19
...
%@see: 《Linear Algebra Done Right (Fourth Eidition)》（Sheldon Axler） P18 1.34
...
%@see: 《Linear Algebra Done Right (Fourth Eidition)》（Sheldon Axler） P45 2.37
...
%@see: 《Linear Algebra Done Right (Fourth Eidition)》（Sheldon Axler） P45 2.39
设\(U\)是域\(F\)上\(n\)维线性空间\(V\)的一个子空间.
如果\(\dim U=\dim V\)，
则\(U=V\).
\begin{proof}
...
%@see: 《Linear Algebra Done Right (Fourth Eidition)》（Sheldon Axler） P41 2.32
...
%@see: 《Linear Algebra Done Right (Fourth Eidition)》（Sheldon Axler） P29 2.4
%@see: 《Linear Algebra Done Right (Fourth Eidition)》（Sheldon Axler） P29 2.7
...
%@see: 《Linear Algebra Done Right (Fourth Eidition)》（Sheldon Axler） P29 2.6
设\(V\)是域\(F\)上的一个线性空间.
...
\begin{proposition}
%@see: 《Linear Algebra Done Right (Fourth Eidition)》（Sheldon Axler） P46 2.42
设\(V\)是一个\(n\)维线性空间.
...
\begin{proposition}
%@see: 《Linear Algebra Done Right (Fourth Eidition)》（Sheldon Axler） P30 2.9
如果线性空间\(V\)可以由某个向量组生成，
那么\(V\)是有限维空间.
\end{proposition}
...
%@see: 《Linear Algebra Done Right (Fourth Eidition)》（Sheldon Axler） P36 2.25
...
%@see: 《Linear Algebra and Its Applications (Second Edition)》（Peter D. Lax） P4 Definition
%@see: 《Linear Algebra Done Right (Fourth Eidition)》（Sheldon Axler） P19 1.36
设\(V_1,V_2\)都是域\(F\)上线性空间\(V\)的子空间，
把\begin{equation*}
%@see: 《高等代数（第三版 下册）》（丘维声） P84 (1)
	\Set{ \alpha_1+\alpha_2 \given \alpha_1\in V_1,\alpha_2\in V_2 }
\end{equation*}称为“\(V_1\)与\(V_2\)的\DefineConcept{和}（sum）”，
记作\(V_1+V_2\).
\end{definition}

\begin{example}
%@see: 《Linear Algebra Done Right (Fourth Eidition)》（Sheldon Axler） P20 1.38
设\(F\)是一个域，
则\begin{equation*}
	U \defeq \Set{
		(x,x,y,y)
...
%@see: 《Linear Algebra Done Right (Fourth Eidition)》（Sheldon Axler） P21 1.40
...
%@see: 《Linear Algebra Done Right (Fourth Eidition)》（Sheldon Axler） P47 2.43
...
%@see: 《Linear Algebra Done Right (Fourth Eidition)》（Sheldon Axler） P21 1.41
...
%@see: 《Linear Algebra Done Right (Fourth Eidition)》（Sheldon Axler） P23 1.45
%@see: 《Linear Algebra Done Right (Fourth Eidition)》（Sheldon Axler） P23 1.46
%@see: 《Linear Algebra Done Right (Fourth Eidition)》（Sheldon Axler） P98 3.94
...
%@see: 《Linear Algebra Done Right (Fourth Eidition)》（Sheldon Axler） P42 2.33
设\(V\)是域\(F\)上\(n\)维线性空间，
则\(V\)的每一个子空间\(U\)都有补空间.
\begin{proof}
