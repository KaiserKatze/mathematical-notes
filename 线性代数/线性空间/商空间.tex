...
\(\pi\)上每一个向量\(\gamma\)可以唯一地表示成\(\gamma_0\)与\(W\)中一个向量\(\vb\eta\)之和：
\(\gamma=\gamma_0+\vb\eta\).

反之，任取\(\vb\eta\in W\)，
有\(\gamma_0+\vb\eta\in\pi\)，
因此\(\pi=\Set{ \gamma_0+\vb\eta \given \vb\eta\in W }\).
...
显然\begin{align*}
	\gamma\in\gamma_0+W
	&\iff
	\gamma=\gamma_0+\vb\eta,\vb\eta\in W \\
	&\iff
	\gamma-\gamma_0=\vb\eta\in W.
\end{align*}
由此看出，
...
于是\(\gamma_0\)所属的等价类\(\overline{\gamma_0}\)为\begin{align*}
	...
	&=\Set{ \gamma\in V \given \gamma=\gamma_0+\vb\eta,\vb\eta\in W } \\
	&=\Set{ \gamma_0+\vb\eta \given \vb\eta\in W }
	=\gamma_0+W.
\end{align*}
...
记\(\alpha - \beta = \vb\delta\)，
则\(\alpha = \vb\delta + \beta \in W + U\).
于是\(V \subseteq W+U\)，
从而\(V = W+U\).
