...
取\(
	\alpha_1 \defeq (0,0,1)^T, 		\allowbreak
	\alpha_2 \defeq (0,0,2)^T, 		\allowbreak
	W_1 \defeq \Span\{(1,0,0)^T\}, 	\allowbreak
	W_2 \defeq \Span\{(0,1,0)^T\}, 	\allowbreak
	W \defeq W_1 + W_2, 			\allowbreak
	S_1 \defeq \alpha_1 + W_1, 		\allowbreak
	S_2 \defeq \alpha_2 + W_2, 		\allowbreak
	S_3 \defeq W
\)，
则有\(
	S_1 \parallel S_3,
