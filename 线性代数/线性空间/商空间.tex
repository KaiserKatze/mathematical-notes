...
\end{align*}
%@see: 《Linear Algebra Done Right (Fourth Eidition)》（Sheldon Axler） P98 3.95
%@see: 《Linear Algebra Done Right (Fourth Eidition)》（Sheldon Axler） P99 3.97
可以记作\(\alpha+W\)，称为“\(W\)的一个\DefineConcept{陪集}（a \emph{translate} of \(W\)）”，
\(\alpha\)称为\DefineConcept{陪集代表}.
特别地，可以将\begin{equation*}
	\overline{0}
	= 0+W
	= \Set{
		\gamma \in V
...
%@see: 《Linear Algebra Done Right (Fourth Eidition)》（Sheldon Axler） P100 3.102
%@see: 《Linear Algebra Done Right (Fourth Eidition)》（Sheldon Axler） P101 3.103
...
%@see: 《Linear Algebra Done Right (Fourth Eidition)》（Sheldon Axler） P99 3.99
...
%@see: 《Linear Algebra Done Right (Fourth Eidition)》（Sheldon Axler） P102 3.105
...
%@see: 《Linear Algebra Done Right (Fourth Eidition)》（Sheldon Axler） P101 3.104
设\(W\)是域\(F\)上线性空间\(V\)的一个子空间，
\(V/W\)是\(V\)对\(W\)的商空间.
把映射\[
	\vb\pi\colon V \to V/W,
