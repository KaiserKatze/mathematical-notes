...
\begin{theorem}\label{theorem:商空间.子空间相同的两个陪集相等的等价条件}
...
\begin{proposition}\label{theorem:商空间.陪集之间成立包含关系的必要条件1}
...
\end{proof}
\end{proposition}
\begin{corollary}\label{theorem:商空间.陪集之间成立包含关系的等价条件1}
设\(V\)是域\(F\)上的一个线性空间，
\(U\)和\(W\)是\(V\)的两个子空间，
向量\(\alpha,\beta \in V\).
\begin{itemize}
	\item \(\alpha + U \subseteq \beta + W\)，
	当且仅当\(\alpha - \beta \in W\)且\(U \subseteq W\).
	\item \(\alpha + U = \beta + W\)，
	当且仅当\(\alpha - \beta \in W\)且\(U = W\).
\end{itemize}
\begin{proof}
\cref{theorem:商空间.陪集之间成立包含关系的必要条件1}
已经证明了“\(\alpha - \beta \in W\)且\(U \subseteq W\)”
是“\(\alpha + U \subseteq \beta + W\)”成立的必要条件.
下面我们证明“\(\alpha - \beta \in W\)且\(U \subseteq W\)”
是“\(\alpha + U \subseteq \beta + W\)”成立的充分条件.

假设\(\alpha - \beta \in W\)，
那么由\cref{theorem:商空间.子空间相同的两个陪集相等的等价条件}
可知\(\alpha + W = \beta + W\).
假设\(U \subseteq W\)，
那么由\cref{theorem:商空间.代表相同的两个陪集成立包含关系的等价条件}
可知\(\alpha + U \subseteq \alpha + W\).
因此\(\alpha + U \subseteq \beta + W\).

由上可知“\(\alpha - \beta \in W\)且\(U = W\)”
显然是“\(\alpha + U = \beta + W\)”的充分条件.
\end{proof}
\end{corollary}
