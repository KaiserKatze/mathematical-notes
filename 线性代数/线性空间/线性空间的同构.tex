...
它把\(\vb\alpha \in V\)映射为\(\alpha\)在\(\AutoTuple{\vb\alpha}{n}\)下的坐标.
...
k \in F\)，
则有\begin{align*}
	(\sigma_2 \circ \sigma_1)(\vb\alpha + \vb\beta)
	&= \sigma_2(\sigma_1(\vb\alpha + \vb\beta)) \\
	&= \sigma_2(\sigma_1(\vb\alpha) + \sigma_1(\vb\beta)) \\
	&= \sigma_2(\sigma_1(\vb\alpha)) + \sigma_2(\sigma_1(\vb\beta)), \\
	(\sigma_2 \circ \sigma_1)(k \vb\alpha)
	&= \sigma_2(\sigma_1(k \vb\alpha)) \\
	&= \sigma_2(k \sigma_1(\vb\alpha)) \\
	&= k (\sigma_2 \circ \sigma_1)(\vb\alpha).
\end{align*}
