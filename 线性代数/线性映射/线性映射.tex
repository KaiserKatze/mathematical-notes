...
%@see: 《Linear Algebra Done Right (Fourth Edition)》（Sheldon Axler） P52 3.1
...
\footnote{
	%@see: 《高等代数》（丁南庆、刘公祥、纪庆忠、郭学军） P203 注记5.1.2(2)
	线性映射又称为\DefineConcept{线性算子}（linear operator）
	或\DefineConcept{同态}（homomorphism）.
}%
...
“线性空间\(V\)上的一个\DefineConcept{线性变换}”
%@see: 《Linear Algebra Done Right (Fourth Edition)》（Sheldon Axler） P133 5.1
或“线性空间\(V\)上的一个\DefineConcept{算子}（operator）”.
\end{definition}

\begin{definition}\label{definition:线性映射.线性函数}
%@see: 《Linear Algebra Done Right (Fourth Edition)》（Sheldon Axler） P105 3.108
%@see: 《高等代数（第三版 下册）》（丘维声） P161 定义1
域\(F\)上的线性空间\(V\)到\(F\)的每一个线性映射称为
“线性空间\(V\)上的一个\DefineConcept{线性函数}（linear functional）”.
\end{definition}
...
%@see: 《Linear Algebra Done Right (Fourth Edition)》（Sheldon Axler） P56 3.10
设\(V,V'\)都是域\(F\)上的线性空间，
\(\vb{A}\)是从\(V\)到\(V'\)的线性映射，
则\(\vb{A}\)有下述性质：
\begin{itemize}
...
%@see: 《Linear Algebra Done Right (Fourth Edition)》（Sheldon Axler） P54 3.4
设\(V\)和\(V'\)都是域\(F\)上的线性空间，
\(V\)的维数是\(n\)，
...
\begin{definition}
%@see: 《Linear Algebra Done Right (Fourth Edition)》（Sheldon Axler） P52 3.2
...
\begin{itemize}
	...
	记作\(\Hom(V,V)\)\footnote{
		...
		%@see: 《高等代数》（丁南庆、刘公祥、纪庆忠、郭学军） P203 注记5.1.2(3.1)
		在有的书上，\(\Hom(V,V)\)又记作\(\operatorname{End}(V)\).
	}.
\end{itemize}
\end{definition}
...
%@see: 《Linear Algebra Done Right (Fourth Edition)》（Sheldon Axler） P55 3.5
设\(V,V'\)都是域\(F\)上的线性空间.
...
\begin{proposition}
%@see: 《高等代数（第三版 下册）》（丘维声） P110
%@see: 《Linear Algebra Done Right (Fourth Edition)》（Sheldon Axler） P55 3.6
设\(V\)和\(V'\)都是域\(F\)上的线性空间，
...
\subsection{线性映射的乘法}
\begin{definition}
%@see: 《Linear Algebra Done Right (Fourth Edition)》（Sheldon Axler） P55 3.7
...
%@see: 《高等代数（第三版 下册）》（丘维声） P110
%@see: 《Linear Algebra Done Right (Fourth Edition)》（Sheldon Axler） P56 3.8
线性映射的乘法适合结合律，
即\begin{equation*}
...
%@see: 《高等代数（第三版 下册）》（丘维声） P110
%@see: 《Linear Algebra Done Right (Fourth Edition)》（Sheldon Axler） P56 3.9
线性映射的乘法不适合交换律.
\begin{proof}
下面举出反例.
...
\begin{definition}
%@see: 《Linear Algebra Done Right (Fourth Edition)》（Sheldon Axler） P82 3.59
%@see: 《Linear Algebra Done Right (Fourth Edition)》（Sheldon Axler） P82 3.61
...
%@see: 《Linear Algebra Done Right (Fourth Edition)》（Sheldon Axler） P82 3.60
可逆线性映射有唯一逆.
\begin{proof}
...
%@see: 《Linear Algebra Done Right (Fourth Edition)》（Sheldon Axler） P83 3.63
设\(V,V'\)都是域\(F\)上的线性空间，
...
%@see: 《高等代数（第三版 下册）》（丘维声） P111
%@see: 《Linear Algebra Done Right (Fourth Edition)》（Sheldon Axler） P137 5.13
%@see: 《Linear Algebra Done Right (Fourth Edition)》（Sheldon Axler） P137 5.14
由于线性变换的乘法满足结合律，
...
\begin{example}\label{example:线性映射.可逆线性变换保持向量与子空间的所属关系}
