...
\begin{definition}
给定\(\vb{A}\in\Hom(V,V')\).
如果存在\(\vb{B}\in\Hom(V',V)\)，
使得\(\vb{A}\vb{B}=\vb{I}_V\)，
其中\(I_V\)是\(V\)上的恒等变换，
则称“\(\vb{A}\)是一个\DefineConcept{可逆线性映射}”
或“线性映射\(\vb{A}\) \DefineConcept{可逆}”，
把\(\vb{B}\)称为“\(\vb{A}\)的\DefineConcept{逆线性映射}”，
简称\DefineConcept{逆映射}，
记作\(\vb{A}^{-1}\).
\end{definition}
...
使得\(\vb{A}\vb{B}=\vb{I}_V\)，
其中\(I_V\)是\(V\)上的恒等变换，
则称“\(\vb{A}\)是一个\DefineConcept{可逆线性变换}”
或“线性变换\(\vb{A}\) \DefineConcept{可逆}”，
把\(\vb{B}\)称为“\(\vb{A}\)的\DefineConcept{逆线性变换}”，
简称\DefineConcept{逆变换}，
记作\(\vb{A}^{-1}\).
\end{definition}
