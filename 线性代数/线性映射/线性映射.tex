...
k \in F\)，
有\begin{align*}
	(\vb{B}\vb{A})(\vb\alpha+\vb\beta)
	&= \vb{B}(\vb{A}(\vb\alpha+\vb\beta)) \\
	&= \vb{B}(\vb{A}\vb\alpha+\vb{A}\vb\beta), \\
	(\vb{B}\vb{A})(k\vb\alpha)
	&= \vb{B}(\vb{A}(k \vb\alpha)) \\
	&= \vb{B}(k \vb{A}\vb\alpha) \\
	&= k(\vb{B}(\vb{A}\vb\alpha)) \\
	&= k((\vb{B}\vb{A}) \vb\alpha),
\end{align*}
...
对于任意\(\vb\alpha,\vb\beta \in V,
l \in F\)，
有\begin{align*}
	(\vb{A}+\vb{B})(\vb\alpha+\vb\beta)
	&= \vb{A}(\vb\alpha+\vb\beta) + \vb{B}(\vb\alpha+\vb\beta) \\
	&= \vb{A}\vb\alpha + \vb{A}\vb\beta + \vb{B}\vb\alpha + \vb{B}\vb\beta \\
	&= (\vb{A}+\vb{B})\vb\alpha + (\vb{A}+\vb{B})\vb\beta, \\
	(\vb{A}+\vb{B})(l\vb\alpha)
	&= \vb{A}(l\vb\alpha) + \vb{B}(l\vb\alpha) \\
	&= l\vb{A}\vb\alpha + l\vb{B}\vb\alpha \\
	&= l(\vb{A}\vb\alpha + \vb{B}\vb\alpha) \\
	&= l(\vb{A}+\vb{B}) \vb\alpha,
\end{align*}
