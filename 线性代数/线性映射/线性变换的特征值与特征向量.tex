...
%@see: 《Linear Algebra Done Right (Fourth Eidition)》（Sheldon Axler） P134 5.5
%@see: 《Linear Algebra Done Right (Fourth Eidition)》（Sheldon Axler） P135 5.8
...
\begin{proposition}
%@see: 《Linear Algebra Done Right (Fourth Eidition)》（Sheldon Axler） P135 5.7
设\(V\)是域\(F\)上的有限维线性空间，
\(\vb{A}\)是\(V\)上的一个线性变换，
\(\vb{I}\)是\(V\)上的恒等变换，
...
%@see: 《Linear Algebra Done Right (Fourth Eidition)》（Sheldon Axler） P136 5.11
设\(V\)是域\(F\)上任意一个线性空间，
\(\vb{A}\)是\(V\)上的一个线性变换.
