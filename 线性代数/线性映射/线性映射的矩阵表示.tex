...
把它称为“线性变换\(\vb{A}\)在基\(\AutoTuple{\alpha}{n}\)下的矩阵”.
...
简记为\(\vb{A}(\alpha_1,\alpha_2,\dotsc,\alpha_n)\)，
那么上式可以化为\[
	\vb{A}(\alpha_1,\alpha_2,\dotsc,\alpha_n)
	=(\alpha_1,\alpha_2,\dotsc,\alpha_n)A.
\]
这就是一个\(n\)阶矩阵\(A\)
是\(V\)上线性变换\(\vb{A}\)
