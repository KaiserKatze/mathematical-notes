...
\begin{itemize}
	...
	即\begin{equation*}
		...
		\quad(i=1,2,\dotsc,s;j=1,2,\dotsc,n),
	\end{equation*}
	则称“\(\vb{A}\)是\DefineConcept{正矩阵}（positive matrix）”.
	...
	即\begin{equation*}
		...
		\quad(i=1,2,\dotsc,s;j=1,2,\dotsc,n),
	\end{equation*}
	则称“\(\vb{A}\)是\DefineConcept{非负矩阵}（non-negative matrix）”.
\end{itemize}
\end{definition}
...
\begin{itemize}
	...
	即\begin{equation*}
		...
		\quad(i=1,2,\dotsc,n),
	\end{equation*}
	则称“\(\vb\beta\)是\DefineConcept{正向量}（positive matrix）”.
	...
	即\begin{equation*}
		...
		\quad(i=1,2,\dotsc,n),
	\end{equation*}
	则称“\(\vb\beta\)是\DefineConcept{非负向量}（non-negative matrix）”.
\end{itemize}
\end{definition}
