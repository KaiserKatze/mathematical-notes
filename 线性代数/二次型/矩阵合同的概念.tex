...
\begin{definition}
设\(\vb{A}\)和\(\vb{B}\)是实数域上的两个\(n\)阶矩阵.
若存在实数域上的一个可逆矩阵\(\vb{C}\)，
使得\begin{equation*}
	\vb{B} = \vb{C}^T \vb{A} \vb{C},
\end{equation*}
则称“\(\vb{A}\)与\(\vb{B}\) \DefineConcept{实相合的}（real congruent）”.
\end{definition}

\begin{definition}
设\(\vb{A}\)和\(\vb{B}\)是复数域上的两个\(n\)阶矩阵.
若存在复数域上的一个可逆矩阵\(\vb{C}\)，
使得\begin{equation*}
	\vb{B} = \vb{C}^H \vb{A} \vb{C},
\end{equation*}
则称“\(\vb{A}\)与\(\vb{B}\) \DefineConcept{复相合的}（complex congruent）”.
\end{definition}
