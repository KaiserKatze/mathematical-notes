...
\begin{enumerate}
	...
	把\(\vb{A}\)称为\DefineConcept{正定矩阵}（positive definite matrix），
	记为\(\vb{A}\succ\vb0\).
	...
	把\(\vb{A}\)称为\DefineConcept{半正定矩阵}（positive semi-definite matrix），
	记为\(\vb{A}\succeq\vb0\).
	...
	把\(\vb{A}\)称为\DefineConcept{负定矩阵}（negative definite matrix），
	记为\(\vb{A}\prec\vb0\).
	...
	把\(\vb{A}\)称为\DefineConcept{半负定矩阵}（negative semi-definite matrix），
	记为\(\vb{A}\preceq\vb0\).
