...
则\(\b1,\b2,\b4\)是\(\B\)的一个列极大无关组，%
相应地，\(\a1,\a2,\a4\)是\(\A\)的一个列极大无关组，%
...
\B = (\AutoTuple{\b}{n}),
\]则\[
(\AutoTuple{\g}{n}) = \A (\AutoTuple{\b}{n}) = (\A\b1,\A\b2,\dotsc,\A\b_n),
\]于是\[
\g_i = \A \b_i,
\quad i=1,2,\dotsc,n.
\]
