...
%@see: 《高等几何（第四版）》（梅向明，刘增贤，王汇淳，王智秋） P123 定义3.1
设\(V,V'\)都是域\(F\)上的线性空间，
\(P,P'\)分别是\(V,V'\)上的射影几何，
\(f\)是从\(V\)到\(V'\)的一个线性同构，
把映射\begin{equation*}
	...
	M \mapsto f(M)
\end{equation*}
称为“（从\(V\)到\(V'\)的线性同构\(f\)诱导的）从射影几何\(P\)到射影几何\(P'\)的\DefineConcept{射影变换}”，
记为\(\mathcal{P}(f)\).
\end{definition}
...
\begin{definition}
%@see: 《高等代数与解析几何（第三版 下册）》（孟道骥） P462 定义10.7.3
设\(\mathcal{P}(V)\)是数域\(K\)上的\(n\)维射影几何，
把从\(\mathcal{P}(V)\)到\(\mathcal{P}(K^{n+1})\)的每一个射影变换
称为“\(\mathcal{P}(V)\)的一个\DefineConcept{射影坐标系}”
或“\(\mathcal{P}(V)\)的一个\DefineConcept{齐次坐标系}”.
\end{definition}

%@see: 《高等代数与解析几何（第三版 下册）》（孟道骥） P462
...
称为“坐标系\(\pi\)的\DefineConcept{参照单形}”.
...
\begin{definition}
%@see: 《高等代数与解析几何（第三版 下册）》（孟道骥） P463 定义10.7.4
设\(\mathcal{P}(V)\)是\(n\ (n\geq1)\)维射影几何，
\(\mathcal{P}(V)\)中\((n+2)\)元组\([U;A_0,A_1,\dotsc,A_n]\)中
任意\(n+1\)个点之和的维数是最大维数，
则称“\([U;A_0,A_1,\dotsc,A_n]\)是射影几何\(\mathcal{P}(V)\)的（以\(U\)为单位点、\((A_0,A_1,\dotsc,A_n)\)为单形的）\DefineConcept{标架}”.
\end{definition}

\begin{example}
%@see: 《高等代数与解析几何（第三版 下册）》（孟道骥） P463 例10.8
...
\begin{example}
%@see: 《高等代数与解析几何（第三版 下册）》（孟道骥） P463 例10.9
