...
由\cref{theorem:商空间.陪集之间成立包含关系的必要条件}
可知\(U \subseteq W\).
...
\begin{proof}
由\cref{theorem:商空间.陪集之间成立包含关系的必要条件}
可知\(\alpha - \beta \in W \subseteq U + W\).
再由\cref{theorem:仿射几何.陪集的交非空的充分必要条件1}
可知\((\alpha + U) \cap (\beta + W) \neq \emptyset\).
任意取定\(\gamma \in (\alpha + U) \cap (\beta + W)\)，
那么\(\gamma \in \alpha + U\)且\(\gamma \in \beta + W\).
