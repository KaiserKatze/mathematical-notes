...
把\begin{equation*}
	...
	\}
\end{equation*}
称为“以\(A,B,C\)为顶点的\DefineConcept{三角形}”，
记作\(\triangle ABC\).
\end{definition}

\begin{definition}
%@see: 《高等代数与解析几何（第三版 下册）》（孟道骥） P447 定义10.4.2
设\(P,A,B,C,A',B',C'\)是不同点，
\(A,B,C\)三点不共线，
\(A',B',C'\)三点不共线，
且\(AA' \cap BB' \cap CC' = P\)，
则称“\(\triangle ABC\)与\(\triangle A'B'C'\)是从点\(P\) \DefineConcept{透射的}”，
把点\(P\)称为\DefineConcept{透射中心}.
\end{definition}
