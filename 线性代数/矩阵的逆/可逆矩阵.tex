...
% 假设\(\vb{B}\vb{A}=\vb0\)，
% 于是\(\DeterminantA{\vb{B}\vb{A}}=\DeterminantA{\vb{B}}\DeterminantA{\vb{A}}=0\)，
% 这与\(\DeterminantA{\vb{A}\vb{B}}=\DeterminantA{\vb{A}}\DeterminantA{\vb{B}}=1\)矛盾，
% 因此\(\vb{B}\vb{A}=\vb{E}\).
% \end{proof}
% \end{lemma}
...
\begin{proof}
必要性.
假设矩阵\(\vb{A}\)可逆，那么存在\(n\)阶方阵\(\vb{B}\)，使得\(\vb{A}\vb{B}=\vb{E}\)，于是\(\DeterminantA{\vb{A}\vb{B}}=\DeterminantA{\vb{E}}\)；
而根据\cref{theorem:行列式.矩阵乘积的行列式}，
\(\DeterminantA{\vb{A}\vb{B}}=\DeterminantA{\vb{A}}\DeterminantA{\vb{B}}=1\)，\(\DeterminantA{\vb{A}}\neq0\).

充分性.
设\(\DeterminantA{\vb{A}}\neq0\)，\(\vb{A}^*\)是\(\vb{A}\)的伴随矩阵.
根据\cref{equation:行列式.伴随矩阵.恒等式1}，
若令\begin{equation*}
	\vb{B}=\frac{1}{\DeterminantA{\vb{A}}} \vb{A}^*,
\end{equation*}
...
则\(\vb{A}\)的逆矩阵存在且唯一，
且有\begin{equation}
	\vb{A}^{-1} = \DeterminantA{\vb{A}}^{-1} \vb{A}^*.
\end{equation}
\begin{proof}
存在性.
在\cref{theorem:逆矩阵.矩阵可逆的充分必要条件1} 的证明过程中，
我们看到矩阵\(\vb{B}=\DeterminantA{\vb{A}}^{-1} \vb{A}^*\)是可逆矩阵\(\vb{A}\)的一个逆矩阵，即\(\vb{A}\vb{B}=\vb{E}\).
...
设\(\vb{A}\)可逆，则\(\DeterminantA{\vb{A}^{-1}} = \DeterminantA{\vb{A}}^{-1}\).
\end{property}
...
\(\DeterminantA{k\vb{A}} = k^n\DeterminantA{\vb{A}}\).
因为\(\vb{A}\)可逆，所以\(\DeterminantA{\vb{A}}\neq0\)；
又因为\(k\neq0\)，所以\(\DeterminantA{k\vb{A}}\neq0\)，即\(k\vb{A}\)可逆.
因此\begin{equation*}
	(k^{-1}\vb{A}^{-1})(k\vb{A})
...
\(\DeterminantA{\vb{A}^T}=\DeterminantA{\vb{A}}\neq0\)，
于是\(\vb{A}^T\)可逆.
...
\begin{property}\label{theorem:逆矩阵.共轭转置矩阵的逆与逆矩阵的共轭转置}
%@see: 《矩阵分析（第3版）》（史荣昌、魏丰） P97
设\(\vb{A}\)可逆，则\(\vb{A}^H\)可逆，且\begin{equation}
	(\vb{A}^H)^{-1} = (\vb{A}^{-1})^H.
\end{equation}
\end{property}
...
且\begin{equation}
	(\vb{A}^*)^{-1}
	= \DeterminantA{\vb{A}}^{-1} \vb{A}
	= (\vb{A}^{-1})^*.
\end{equation}
\begin{proof}
因为\begin{align*}
	(\vb{A}^*)^{-1}
	&= \left( \DeterminantA{\vb{A}} \vb{A}^{-1} \right)^{-1}
		\tag{\cref{theorem:逆矩阵.逆矩阵的唯一性}} \\
	&= \DeterminantA{\vb{A}}^{-1} (\vb{A}^{-1})^{-1}
...
证明：\((\vb{A}^*)^m = \vb{E}\).
\begin{proof}
由\(\vb{A}^m = \vb{E}\)得\(\DeterminantA{\vb{A}}^m = 1\)，\(\vb{A}\)可逆，
那么\(\vb{A}^* = \DeterminantA{\vb{A}} \vb{A}^{-1}\)，
于是\begin{equation*}
	(\vb{A}^*)^m
	= (\DeterminantA{\vb{A}} \vb{A}^{-1})^m
	= \DeterminantA{\vb{A}}^m (\vb{A}^{-1})^m
	= (\vb{A}^m)^{-1}
	= \vb{E}.
	\qedhere
\end{equation*}
...
\end{equation*}
\begin{proof}
因为\(\vb{A}\)、\(\vb{B}\)为可逆矩阵，\(\DeterminantA{\vb{A}} \neq 0\)，\(\DeterminantA{\vb{B}} \neq 0\).
所以\(\DeterminantA{\vb{M}}=\DeterminantA{\vb{A}}\DeterminantA{\vb{B}} \neq 0\)，即\(\vb{M}\)可逆.
...
得到\begin{gather*}
	...
	\end{bmatrix}^*
	= \begin{bmatrix}
		\DeterminantA{\vb{B}} \vb{A}^* & -\vb{A}^*\vb{C}\vb{B}^* \\
		\vb0 & \DeterminantA{\vb{A}} \vb{B}^*
	\end{bmatrix}, \\
	\begin{bmatrix}
		\vb{A} & \vb0 \\
		\vb{D} & \vb{B}
	\end{bmatrix}^*
	= \begin{bmatrix}
		\DeterminantA{\vb{B}} \vb{A}^* & \vb0 \\
		-\vb{B}^* \vb{D} \vb{A}^* & \DeterminantA{\vb{A}} \vb{B}^*
	\end{bmatrix}, \\
	\begin{bmatrix}
		\vb{C} & \vb{A} \\
		\vb{B} & \vb0
