...
%@see: 《矩阵分析（第3版）》（史荣昌、魏丰） P55 定义2.1.1
...
%@see: 《高等代数》（丁南庆、刘公祥、纪庆忠、郭学军） P267
%@see: 《矩阵分析（第3版）》（史荣昌、魏丰） P56 定义2.1.3
...
%@see: 《矩阵分析（第3版）》（史荣昌、魏丰） P56 定理2.1.1
设\(A(\lambda) \in M_n(F[\lambda])\)，
则\begin{itemize}
	\item \(A(\lambda) \in \GeneralLinearGroup_n(F[\lambda])\)
	当且仅当\(\DeterminantA{A(\lambda)}\)是一个零次多项式；
	\item 如果\(A(\lambda) \in \GeneralLinearGroup_n(F[\lambda])\)，
...
%@see: 《矩阵分析（第3版）》（史荣昌、魏丰） P55 定义2.1.4
...
\end{gather*}
%@see: 《高等代数》（丁南庆、刘公祥、纪庆忠、郭学军） P269
%@see: 《矩阵分析（第3版）》（史荣昌、魏丰） P57 定理2.1.2
与数字矩阵的初等变换一样，
...
%@see: 《矩阵分析（第3版）》（史荣昌、魏丰） P57 定义2.1.5
...
%@see: 《高等代数》（丁南庆、刘公祥、纪庆忠、郭学军） P269
%@see: 《矩阵分析（第3版）》（史荣昌、魏丰） P57 定理2.1.3
...
\begin{lemma}
%@see: 《矩阵分析（第3版）》（史荣昌、魏丰） P58 引理2.1.1
...
%@see: 《矩阵分析（第3版）》（史荣昌、魏丰） P58 定理2.1.4
...
%@see: 《矩阵分析（第3版）》（史荣昌、魏丰） P59 定义2.1.6
...
%@see: 《矩阵分析（第3版）》（史荣昌、魏丰） P66 推论2.1.2
设\(A(\lambda) \in M_n(F[\lambda])\)，
则\(A(\lambda)\)可逆
...
\begin{corollary}
%@see: 《矩阵分析（第3版）》（史荣昌、魏丰） P66 推论2.1.1
设\(A(\lambda) \in M_n(F[\lambda])\)，
则\(A(\lambda)\)可逆
...
存在\(P(\lambda) \in \GeneralLinearGroup_m(F[\lambda])\)及\(Q(\lambda) \in \GeneralLinearGroup_n(F[\lambda])\)
使得\(
	B(\lambda)
...
%@see: 《矩阵分析（第3版）》（史荣昌、魏丰） P64 定义2.1.7
...
%@see: 《矩阵分析（第3版）》（史荣昌、魏丰） P64 定理2.1.5
...
设矩阵\begin{equation*}
	...
	\end{bmatrix}_{m \times n}
\end{equation*}
是矩阵\(A(\lambda) \in M_{m \times n}(F[\lambda])\)的史密斯标准型，
则\(A(\lambda)\)的行列式因子为\begin{equation}
%@see: 《矩阵分析（第3版）》（史荣昌、魏丰） P65 (2.1.4)
	D_k(\lambda)
	= \begin{cases}
		d_1(\lambda) ~ d_2(\lambda) \dotsm d_k(\lambda),
		& 1 \leq k \leq r, \\
		0,
		& r < k \leq \min\{m,n\}.
	\end{cases}.
...
%@see: 《矩阵分析（第3版）》（史荣昌、魏丰） P65 定理2.1.6
\(\lambda\) - 矩阵的史密斯标准型是唯一的.
%TODO proof
\end{theorem}

\begin{theorem}\label{theorem:lambda矩阵.两个lambda矩阵等价的等价条件1}
%@see: 《高等代数》（丁南庆、刘公祥、纪庆忠、郭学军） P275 定理6.2.5
%@see: 《矩阵分析（第3版）》（史荣昌、魏丰） P65 定理2.1.7
%@see: 《矩阵分析（第3版）》（史荣昌、魏丰） P65 定理2.1.8
...
%@see: 《矩阵分析（第3版）》（史荣昌、魏丰） P66 定义2.2.1
设\(A(\lambda) \in M_{m \times n}(F[\lambda])\)且\(\rank A(\lambda) = r \geq 1\).
将\(A(\lambda)\)的不变因子\(
	d_1(\lambda),
	d_2(\lambda),
...
\)分解为互不相同的首一不可约因式的方幂的乘积\begin{equation*}
	\begin{array}{c}
		d_1(\lambda) = p_1(\lambda)^{k_{11}} p_2(\lambda)^{k_{12}} \dotsm p_t(\lambda)^{k_{1t}}, \\
		d_2(\lambda) = p_1(\lambda)^{k_{21}} p_2(\lambda)^{k_{22}} \dotsm p_t(\lambda)^{k_{2t}}, \\
		\hdotsfor{1} \\
		d_r(\lambda) = p_1(\lambda)^{k_{r1}} p_2(\lambda)^{k_{r2}} \dotsm p_t(\lambda)^{k_{rt}},
	\end{array}
\end{equation*}
其中\(p_j(\lambda)\ (j=1,2,\dotsc,t)\)都是域\(F\)上的首一不可约多项式，
...
\begin{theorem}\label{theorem:lambda矩阵.两个lambda矩阵等价的等价条件2}
%@see: 《矩阵分析（第3版）》（史荣昌、魏丰） P67
设\(A(\lambda), B(\lambda) \in M_{m \times n}(F[\lambda])\)且\(A(\lambda) \neq 0, B(\lambda) \neq 0\)，
则以下命题等价：\begin{itemize}
	\item \(A(\lambda)\)与\(B(\lambda)\)等价；
	\item \(A(\lambda)\)与\(B(\lambda)\)具有相同的初等因子.
\end{itemize}
\begin{proof}
假设\(A(\lambda)\)与\(B(\lambda)\)等价，
那么由\cref{theorem:lambda矩阵.两个lambda矩阵等价的等价条件1} 可知，
\(A(\lambda)\)与\(B(\lambda)\)具有相同的不变因子，
于是\(A(\lambda)\)与\(B(\lambda)\)具有相同的初等因子.

假设\(A(\lambda)\)与\(B(\lambda)\)具有相同的初等因子，
那么\(A(\lambda)\)与\(B(\lambda)\)具有相同的不变因子，
再由\cref{theorem:lambda矩阵.两个lambda矩阵等价的等价条件1} 可知，
...
%@see: 《矩阵分析（第3版）》（史荣昌、魏丰） P67 定理2.2.1
设\(A(\lambda), B(\lambda) \in M_{m \times n}(F[\lambda])\)且\(A(\lambda) \neq 0, B(\lambda) \neq 0\)，
...
\begin{example}
%@see: 《矩阵分析（第3版）》（史荣昌、魏丰） P68 例2.2.1
...
%@see: 《矩阵分析（第3版）》（史荣昌、魏丰） P68 定理2.2.2
%@see: 《矩阵分析（第3版）》（史荣昌、魏丰） P71 定理2.2.3
%@see: 《矩阵分析（第3版）》（史荣昌、魏丰） P71 定理2.2.4
设\(
...
%@see: 《矩阵分析（第3版）》（史荣昌、魏丰） P71 例2.2.2

\subsection{\texorpdfstring{$\lambda$}{\textlambda} - 矩阵的相似}
我们知道，数字矩阵\(A \in M_n(F)\)的特征矩阵\(\lambda I_n - A\)是一个\(\lambda\) - 矩阵.
本节来证明两个数字矩阵相似当且仅当它们的特征矩阵等价.

\begin{lemma}
%@see: 《矩阵分析（第3版）》（史荣昌、魏丰） P72 引理
设\(A,B \in M_n(F)\)，
则\(A\)与\(B\)相似
当且仅当\(\lambda I_n - A\)与\(\lambda I_n - B\)相似.
\end{lemma}

\begin{lemma}
%@see: 《高等代数》（丁南庆、刘公祥、纪庆忠、郭学军） P281 引理6.3.1
设\(A(\lambda) \in M_{m \times n}(F[\lambda])\).
如果\(A(\lambda) \neq 0\)，
则存在唯一的自然数\(d\)，
存在\(A_0,A_1,\dotsc,\allowbreak A_d \in M_{m \times n}(F)\)，
使得\(A(\lambda)\)可以分解为以矩阵为“系数”的多项式\begin{equation}
%@see: 《高等代数》（丁南庆、刘公祥、纪庆忠、郭学军） P281 (6.3.1)
	A(\lambda)
	= \lambda^d A_d
	+ \lambda^{d-1} A_{d-1}
	+ \dotsb
...
\begin{lemma}
%@see: 《高等代数》（丁南庆、刘公祥、纪庆忠、郭学军） P282 引理6.3.2
设\(
	A(\lambda) \in M_{m \times n}(F[\lambda]),
	B(\lambda) \in M_{n \times p}(F[\lambda])
\)
并且\begin{gather*}
	A(\lambda) \defeq A_d \lambda^d + A_{d-1} \lambda^{d-1} + \dotsb + A_1 \lambda + A_0, \\
	B(\lambda) \defeq B_l \lambda^l + B_{l-1} \lambda_{l-1} + \dotsb + B_1 \lambda + B_0,
\end{gather*}
其中\(
	A_0,A_1,\dotsc,A_d
	\in M_{m \times n}(F[\lambda]),
	A_d \neq 0,
	B_0,B_1,\dotsc,B_l
	\in M_{n \times p}(F[\lambda]),
	B_l \neq 0
\).
若\begin{equation*}
	A(\lambda) B(\lambda) \neq 0,
\end{equation*}
则\begin{equation*}
	\deg( A(\lambda) B(\lambda) )
	\leq \deg A(\lambda) + \deg B(\lambda),
\end{equation*}
当且仅当\(A_d B_l \neq 0\)时，
上式取“\(=\)”号.
\end{lemma}
...
举例说明：存在\(
	A(\lambda) \in M_{m \times n}(F[\lambda]),
	B(\lambda) \in M_{n \times m}(F[\lambda])
\)，
使得\begin{equation*}
	\deg( A(\lambda) B(\lambda) )
	\neq
	\deg( B(\lambda) A(\lambda) ).
\end{equation*}
\end{example}

\begingroup

\def\LV{\operatorname{L.V.}}
\def\RV{\operatorname{R.V.}}
\begin{definition}
%@see: 《高等代数》（丁南庆、刘公祥、纪庆忠、郭学军） P282 注记6.3.3(2)
设\(
	A(\lambda) \in M_n(F[\lambda]),
	B \in M_n(F)
\)，
记\(d \defeq \deg A(\lambda)\)，
将\(A(\lambda)\)分解为\begin{align*}
	A(\lambda)
	&= \lambda^d A_d
	+ \lambda^{d-1} A_{d-1}
	+ \dotsb
...
定义：\begin{align*}
	...
	\end{cases}
\end{align*}
将\(\LV(A(\lambda), B)\)称为“\(A(\lambda)\)在\(B\)处的\DefineConcept{左值}（left value）”，
将\(\LV(A(\lambda), B)\)称为“\(A(\lambda)\)在\(B\)处的\DefineConcept{右值}（right value）”.
\end{definition}

\begin{lemma}
%@see: 《高等代数》（丁南庆、刘公祥、纪庆忠、郭学军） P282 引理6.3.4
设\(
	A \in M_n(F),
	U(\lambda) \in M_n(F[\lambda])
\)，
则存在唯一的\(Q(\lambda), R(\lambda) \in M_n(F[\lambda])\)及\(W, V \in M_n(F)\)
使得\begin{equation*}
	(\lambda I_n - A) Q(\lambda) + W
	= U(\lambda)
	= R(\lambda) (\lambda I_n - A) + V,
\end{equation*}
并且\(
	W = \LV(U(\lambda), A),
	V = \RV(U(\lambda), A)
...
\begin{theorem}
%@see: 《高等代数》（丁南庆、刘公祥、纪庆忠、郭学军） P283 定理6.3.5
%@see: 《矩阵分析（第3版）》（史荣昌、魏丰） P72 定理2.2.5
设\(A,B \in M_n(F)\)，
则\(A\)与\(B\)相似
当且仅当\(\lambda I_n - A\)与\(\lambda I_n - B\)等价.
\end{theorem}

\begin{corollary}
%@see: 《高等代数》（丁南庆、刘公祥、纪庆忠、郭学军） P285 推论6.3.6
设\(
	A, B \in M_n(F),
	P(\lambda), Q(\lambda) \in \GeneralLinearGroup_n(F[\lambda])
\)且\(
	P(\lambda) (\lambda I_n - A) Q(\lambda)
	= \lambda I_n - B
\)，
记\(
	M(\lambda) \defeq P(\lambda)^{-1},
	N(\lambda) \defeq Q(\lambda)^{-1}
\)，
则\begin{gather*}
	\left( \LV(P(\lambda), B) \right)
	\left( \LV(M(\lambda), A) \right)
	= I_n, \\
	\left( \RV(Q(\lambda), B) \right)
	\left( \RV(N(\lambda), A) \right)
	= I_n, \\
	\LV(P(\lambda), B)
	= \RV(N(\lambda), A), \\
	B = P^{-1} A P,
...
\begin{definition}
%@see: 《高等代数》（丁南庆、刘公祥、纪庆忠、郭学军） P288 注记6.3.8
设\(V\)是域\(F\)上的一个\(n\)维线性空间，
\(\sigma\)是\(V\)上的一个线性变换，
\(A\)是\(\sigma\)在\(V\)的一个基\(\AutoTuple{\epsilon}{n}\)下的矩阵.
把数字矩阵\(A\)的特征矩阵\(\lambda I_n - A\)的行列式因子、不变因子、初等因子
分别称为矩阵\(A\)（或线性变换\(\sigma\)）的\DefineConcept{行列式因子}、\DefineConcept{不变因子}、\DefineConcept{初等因子}.
\end{definition}

%@see: 《高等代数》（丁南庆、刘公祥、纪庆忠、郭学军） P288 注记6.3.8
由于\(
	\DeterminantA{\lambda I_n - A}
	= \lambda^n - p_1 \lambda^{n-1}
	+ \dotsb + (-1)^{n-1} p_{n-1} \lambda
	+ (-1)^n p_n
	\neq 0  % 这里是指特征多项式不恒等于零
\)，
因此\(\rank(\lambda I_n - A) = n\)，
从而矩阵\(A\)（线性变换\(\sigma\)）有\(n\)个行列式因子和\(n\)个不变因子，
而且\(\DeterminantA{\lambda I_n - A}\)
等于\(A\)的\(n\)阶行列式因子\(D_n(\lambda)\)，
也等于\(A\)的所有不变因子的乘积\(\prod_{i=1}^n d_i(\lambda)\)，
还等于\(A\)的所有初等因子的乘积.
\begin{theorem}
%@see: 《高等代数》（丁南庆、刘公祥、纪庆忠、郭学军） P288 定理6.3.9
%@see: 《矩阵分析（第3版）》（史荣昌、魏丰） P74 定理2.2.6
%@see: 《矩阵分析（第3版）》（史荣昌、魏丰） P74 定理2.2.7
设\(A,B \in M_n(F)\)，
则以下命题等价：\begin{itemize}
	\item \(A\)与\(B\)相似；
	\item \(A\)与\(B\)具有相同的行列式因子；
	\item \(A\)与\(B\)具有相同的不变因子；
	\item \(A\)与\(B\)具有相同的初等因子.
	% 这里之所以不叙述为“\(A\)与\(B\)具有相同的秩和初等因子”，
	% 是因为数字矩阵的特征矩阵的秩为\(\rank(\lambda I_n - A) = n\)，
	% 也就是说同型数字矩阵的特征矩阵一定具有相同的秩.
\end{itemize}
\end{theorem}

\begin{example}
%@see: 《矩阵分析（第3版）》（史荣昌、魏丰） P74 例2.2.4
设数字矩阵\(A \in M_n(F)\)的初等因子为\(\lambda,\lambda,\lambda^2,(\lambda-1)^2,\lambda+1\).
求\(A\)的阶数\(n\)、不变因子和史密斯标准型.
\begin{solution}
因为特征矩阵\(\lambda I_n - A\)的行列式\(\DeterminantA{\lambda I_n - A}\)
等于\(A\)的所有初等因子的乘积\begin{equation*}
	f(\lambda)
	\defeq
	\lambda \cdot \lambda \cdot \lambda^2 \cdot (\lambda-1)^2 \cdot (\lambda+1)
	= \lambda^4(\lambda-1)^2(\lambda+1),
\end{equation*}
这里\(f(\lambda)\)是一个7阶多项式，
所以\(A\)的阶数为\(n=7\)，
它的史密斯标准型为\begin{equation*}
	\begin{bmatrix}
		1 \\
		& 1 \\
		&& 1 \\
...
\begin{definition}
%@see: 《高等代数》（丁南庆、刘公祥、纪庆忠、郭学军） P234 例5.5.8
设\(
	f(\lambda)
	\defeq
	c_0 + c_1 \lambda + \dotsb + c_{n-1} \lambda^{n-1} + \lambda^n
	\in F[\lambda]
\).
把矩阵\begin{equation*}
	\begin{bmatrix}
	...
	\end{bmatrix}_n
\end{equation*}
称为“首一多项式\(f(\lambda)\)的\DefineConcept{友矩阵}（companion matrix）”.
\end{definition}

\begin{definition}
%@see: 《高等代数》（丁南庆、刘公祥、纪庆忠、郭学军） P288 定义6.3.10
设\(
%@see: 《高等代数》（丁南庆、刘公祥、纪庆忠、郭学军） P288 (6.3.8)
	R
	\defeq
	\diag(R_1,R_2,\dotsc,R_s)
	\in M_n(F)
\)，
其中\(R_i \in M_{n_i}(F)\ (i=1,2,\dotsc,s)\)是首一多项式\(d_i(\lambda) \in F[\lambda]\)的友矩阵，
并且\(\ExactlyDividedBy{ d_{i+1}(\lambda) }{ d_i(\lambda) }\ (i=1,2,\dotsc,s-1)\)，
则称“\(R\)是\(F\)上的一个\DefineConcept{有理标准型}（rational canonical form）”
或“\(R\)是\(F\)上的一个\DefineConcept{弗罗贝尼乌斯标准型}（Frobenius canonical form）”.
\end{definition}
...
% 求史密斯标准型有三种常见方法：
% 1. 利用初等变换，将lambda矩阵化为对角矩阵
% 2. 先求行列式因子，再求不变因子，最后写出史密斯标准型
% 3. 先求初等因子和秩，再求不变因子，最后写出史密斯标准型

% 求不变因子的方法：
% 1. 利用初等变换，求出史密斯标准型，再写出不变因子
% 2. 先求行列式因子，再求不变因子
% 3. 先求初等因子和秩，再求不变因子
...
% 1. 根据行列式因子的定义，直接计算
%		求行列式因子的两个技巧
%		- 如果某阶行列式因子等于1，则比它低阶的行列式因子也都等于1；
%		- 如果某阶子式是非零常数，则该阶行列式因子等于1.
% 2. 先求不变因子，再求行列式因子

% 求初等因子的方法：
% 1. 先求不变因子，再写出初等因子
% 2. 如果lambda矩阵是对角矩阵，那么将主对角线上的多项式元素进行因式分解，得到的因式就是初等因子
...
% 求数字矩阵的若尔当标准型的步骤：
% 1. 先求初等因子，
% 2. 再按初等因子的个数和次数确定若尔当块的个数和阶数，
% 3. 然后根据初等因子的底数的减数确定若尔当块的主对角线上的元素，
% 4. 最后将若尔当块组装成若尔当标准型.

% 数字矩阵相似，当且仅当它们的特征矩阵等价
