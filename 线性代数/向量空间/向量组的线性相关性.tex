...
%两端分别与\(\a_1\)作内积，
%即\[
%	\VectorInnerProductDot{(k_1 \a_1 + k_2 \a_2 + \dotsb + k_m \a_m)}{\a_1}
%	= \VectorInnerProductDot{\z}{\a_1};
%\]
%由内积性质，\[
%	k_1 (\VectorInnerProductDot{\a_1}{\a_1})
%	+ k_2 (\VectorInnerProductDot{\a_2}{\a_1})
%	+ \dotsb
%	+ k_m (\VectorInnerProductDot{\a_m}{\a_1})
%	= \VectorInnerProductDot{\z}{\a_1},
%\]
%其中\(\VectorInnerProductDot{\z}{\a_1} = 0\)，
%\(\VectorInnerProductDot{\a_j}{\a_1} = 0\ (j=2,3,\dotsc,m)\)，
%故\(k_1 \VectorInnerProductDot{\a_1}{\a_1} = 0\)，
%而\(\VectorInnerProductDot{\a_1}{\a_1} > 0\)，
%所以\(k_1=0\).
