...
则“向量\(\b\)可由\(A\)线性表出”的充要条件是“\(B=\{\AutoTuple{\a}{s},\b\}\)线性相关”.
\begin{proof}
先证必要性.
...
设向量组\(A=\{\AutoTuple{\a}{s}\}\)线性无关.
那么“\(\b\)不能由\(A\)线性表出”的充要条件是“\(B=\{\AutoTuple{\a}{s},\b\}\)线性无关”.
\end{corollary}
...
\begin{enumerate}
	...
	\begin{enumerate}
		\item \(\begin{aligned}[t]
			&\text{向量组\(\AutoTuple{\a}{s}\ (s\geqslant1)\)线性相关} \\
			&\iff
			\text{它们有系数不全为零的线性组合等于零向量}.
		\end{aligned}\)
		\item \(\begin{aligned}[t]
			&\text{向量组\(\AutoTuple{\a}{s}\ (s\geqslant1)\)线性无关} \\
			&\iff
	...
	\begin{enumerate}
		\item \(\begin{aligned}[t]
			&\text{向量组\(\AutoTuple{\a}{s}\ (s\geqslant2)\)线性相关} \\
			&\iff
			\text{其中至少有一个向量可以由其余向量线性表出}.
		\end{aligned}\)
		\item \(\begin{aligned}[t]
			&\text{向量组\(\AutoTuple{\a}{s}\ (s\geqslant2)\)线性无关} \\
			&\iff
	...
	\begin{enumerate}
		\item \(\begin{aligned}[t]
			&\text{列向量组\(\AutoTuple{\a}{s}\ (s\geqslant1)\)线性相关} \\
			&\iff
		...
		\end{aligned}\)
		\item \(\begin{aligned}[t]
			&\text{列向量组\(\AutoTuple{\a}{s}\ (s\geqslant1)\)线性无关} \\
			&\iff
