...
或称把它称为“矩阵\(\A\)的\DefineConcept{核空间}（kernel）”，
并记为\(\Ker\A\).
...
设齐次线性方程组\(\A\x=\vb0\)的系数矩阵\(\A\)是\(s \times n\)矩阵.
若\(\rank\A = r < n\)，
则\begin{itemize}
...
\end{equation}
\begin{proof}
因为\(\A\x=\vb0\)、\((\A\A^T)\x=\vb0\)和\((\A^T\A)\x=\vb0\)同解，
