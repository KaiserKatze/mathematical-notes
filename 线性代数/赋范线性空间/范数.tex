...
\begin{example}
%@see: 《矩阵分析（第3版）》（史荣昌、魏丰） P199 例5.6.6
设矩阵\(A \in M_n(\mathbb{C})\).
证明：\begin{equation*}
	\mu_1(A)
	\defeq
...
矩阵的测度具有如下性质.
\begin{theorem}
%@see: 《矩阵分析（第3版）》（史荣昌、魏丰） P200 定理5.6.1
...
\begin{theorem}
%@see: 《矩阵分析（第3版）》（史荣昌、魏丰） P200 定理5.6.1 (3)
设矩阵\(A,B \in M_n(\mathbb{C})\)，
\(\mu\)是矩阵关于\(L_p\)范数的测度，
则\begin{equation*}
...
\begin{theorem}
%@see: 《矩阵分析（第3版）》（史荣昌、魏丰） P200 定理5.6.1 (4)
设矩阵\(A,B \in M_n(\mathbb{C})\)，
\(\mu\)是矩阵关于\(L_p\)范数的测度，
则\begin{equation*}
	\mu(A + B)
...
\begin{theorem}
%@see: 《矩阵分析（第3版）》（史荣昌、魏丰） P200 定理5.6.1 (5)
设矩阵\(A,B \in M_n(\mathbb{C})\)，
\(\mu\)是矩阵关于\(L_p\)范数的测度，
则\begin{equation*}
	- \norm{A}_p
...
\begin{theorem}
%@see: 《矩阵分析（第3版）》（史荣昌、魏丰） P200 定理5.6.1 (6)
设矩阵\(A,B \in M_n(\mathbb{C})\)，
\(\mu\)是矩阵关于\(L_p\)范数的测度，
则\begin{equation*}
	- \mu(-A)
...
\begin{theorem}
%@see: 《矩阵分析（第3版）》（史荣昌、魏丰） P200 定理5.6.1 (7)
设矩阵\(A,B \in M_n(\mathbb{C})\)，
\(\mu\)是矩阵关于\(L_p\)范数的测度，
则\begin{equation*}
