...
% 于是\(x \notin \TopoClosureL{E}\).
% 再假设\(x \notin \TopoClosureL{E}\)，
% 因为\(X-\TopoClosureL{E}\)是开集，
% 存在\(r>0\)使得\(B(x,r) \subseteq X-\TopoClosureL{E} \subseteq X-E\).
% 因此\(x \in \TopoClosureL{E} \iff (\forall r>0)[B(x,r) \cap E \neq \emptyset]\).
