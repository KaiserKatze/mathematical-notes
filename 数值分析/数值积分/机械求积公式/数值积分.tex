...
也可以将\begin{equation}\label{equation:数值积分.左矩形公式}
	f(a) (b-a)
\end{equation}
作为定积分\(\int_a^b f(x) \dd{x}\)的近似值，
...
\end{equation}
作为定积分\(\int_a^b f(x) \dd{x}\)的近似值，
也可以将\begin{equation}\label{equation:数值积分.右矩形公式}
	f(b) (b-a)
\end{equation}
作为定积分\(\int_a^b f(x) \dd{x}\)的近似值.
我们把\cref{equation:数值积分.梯形公式} 称为\DefineConcept{梯形公式}，
把\cref{equation:数值积分.左矩形公式} 称为\DefineConcept{左矩形公式}，
把\cref{equation:数值积分.中矩形公式} 称为\DefineConcept{中矩形公式}，
把\cref{equation:数值积分.右矩形公式} 称为\DefineConcept{右矩形公式}.

一般地，我们常常将\begin{equation}\label{equation:数值积分.机械求积公式}
%@see: 《数值分析（第5版）》（李庆扬、王能超、易大义） P98 (1.3)
...
即\begin{equation*}
%@see: 《数值分析（第5版）》（李庆扬、王能超、易大义） P98 (1.4)
	\int_a^b x^i \dd{x}
	\equiv \frac{1}{i+1} (b^{i+1} - a^{i+1})
