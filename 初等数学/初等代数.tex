...
\subsection{一元二次方程}
一元二次方程的一般形式为：
\begin{equation}\label{equation:一元二次方程.一元二次方程的一般形式}
	ax^2 + bx + c = 0, \quad a \neq 0,
\end{equation}
其中，\(ax^2\)称为\DefineConcept{二次项}，
\(bx\)称为\DefineConcept{一次项}，
\(c\)称为\DefineConcept{常数项}，
把\(a\)、\(b\)、\(c\)统称为“一元二次方程 \labelcref{equation:一元二次方程.一元二次方程的一般形式} 的\DefineConcept{系数}”.

一元二次方程 \labelcref{equation:一元二次方程.一元二次方程的一般形式} 两端同除以\(a\)，得\begin{equation*}
...
称之为一元二次方程 \labelcref{equation:一元二次方程.一元二次方程的一般形式}
...
设\(x_1,x_2\)是一元二次方程 \labelcref{equation:一元二次方程.一元二次方程的一般形式} 的两个根，
则有\begin{equation*}
	x_1 + x_2 = -\frac{b}{a},
	\qquad
...
\end{equation*}
将上式与一元二次方程 \labelcref{equation:一元二次方程.一元二次方程的一般形式} 比较可得\begin{equation*}
	b = -a (x_1 + x_2),
	\qquad
	c = a x_1 x_2.
\end{equation*}
...
\subsection{一元三次方程}
对于一般的一元三次方程\begin{equation}\label{equation:一元三次方程.一元三次方程的一般形式}
...
\hfill
\begin{enumerate}
	\item 首先在一元三次方程 \labelcref{equation:一元三次方程.一元三次方程的一般形式} 等号两边同除以\(a\)，
	得\begin{equation*}
...
设\(x_1,x_2,x_3\)是一元三次方程 \labelcref{equation:一元三次方程.一元三次方程的一般形式} 的三个根，
则有\begin{equation*}
