...
由数与字母的积组成的代数式叫做\DefineConcept{单项式}.
例如\[
	1, \qquad
	a, \qquad
	4b^2, \qquad
	7abc
\]都是单项式.
单项式中的数叫做这个单项式的\DefineConcept{系数}.
例如\(a\)的系数是\(1\)，
\(4b^2\)的系数是\(4\)，
而\(7abc\)的系数是\(7\).
...
由几个单项式的和组成的代数式叫做\DefineConcept{多项式}.
多项式中的每个单项式叫做这个多项式的\DefineConcept{项}，
其中不含字母的项叫做这个多项式的\DefineConcept{常数项}.
例如\[
	1+a, \qquad
	b+2c^2+\frac12cde,
\]都是多项式.
