...
\subsection{开平方}
如果\(b\)的平方\(b^2\)等于\(a\)，
就把\(b\)称为“\(a\)的\DefineConcept{平方根}（square root）”.
%@see: https://mathworld.wolfram.com/SquareRoot.html
...
\subsection{开立方}
如果\(b\)的立方\(b^2\)等于\(a\)，
就把\(b\)称为“\(a\)的\DefineConcept{立方根}（cube root）”.
...
一般地，
我们把符号\(\sqrt[n]{a}\)
读作“\(n\) 次\DefineConcept{根号} \(a\)（\(a\) radical \(n\)，the \(n\)-th root of \(a\)）”；
%@see: https://mathworld.wolfram.com/Radical.html
%@see: https://mathworld.wolfram.com/nthRoot.html
%@see: https://mathworld.wolfram.com/Vinculum.html
把\(a\)称为\DefineConcept{被开方数}（radicand）.
%@see: https://mathworld.wolfram.com/Radicand.html
当不必特别强调XX时，
我们把\(\sqrt[n]{a}\)称为一个\DefineConcept{根式}（surd）.
%@see: https://mathworld.wolfram.com/Surd.html
