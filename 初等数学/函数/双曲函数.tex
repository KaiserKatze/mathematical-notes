...
\begin{gather}
	\arsinh x
	\defeq
	\ln(x + \sqrt{x^2 + 1}), \quad x \in (-\infty,+\infty). \\
	\arcosh x
	\defeq
	\ln(x - \sqrt{x^2 - 1}), \quad x \in [1,+\infty). \\
	\artanh x
	\defeq
	\frac{1}{2} \ln\frac{1 + x}{1 - x}, \quad x \in (-1,1). \\
	\arcoth x
	\defeq
	\frac{1}{2} \ln\frac{x + 1}{x - 1}, \quad x \in (-\infty,-1) \cup (1,+\infty).
\end{gather}
这里，
\(\arsinh x\)被称为\DefineConcept{反双曲正弦}，
\(\arcosh x\)被称为\DefineConcept{反双曲余弦}，
\(\artanh x\)被称为\DefineConcept{反双曲正切}，
\(\arcoth x\)被称为\DefineConcept{反双曲余切}.
\end{definition}
