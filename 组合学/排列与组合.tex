...
\begin{proof}
由\cref{theorem:组合数性质7}
有\(C_{n+m}^k = \sum_{r=0}^k C_n^r C_m^{k-r}\).
令\(m \defeq n\)，
再令\(k \defeq n\)，
得\begin{equation*}
	C_{2n}^n
	= \sum_{r=0}^n C_n^r C_n^{n-r}
	% \cref{theorem:组合数性质1}
	% \(C_n^k = C_n^{n-k}\).
	= \sum_{r=0}^n C_n^r C_n^r
	= \sum_{r=0}^n (C_n^r)^2.
	\qedhere
\end{equation*}
\end{proof}
