...
\(R(x,y,z)\)在\(\Sigma\)上连续.
如果\(\Sigma\)取上侧，
则由对坐标的曲面积分计算公式 \labelcref{equation:线积分与面积分.第二类曲面积分的计算式1} 有\begin{equation*}
...
另一方面，因上述有向曲面\(\Sigma\)的法向量的方向余弦为\begin{equation*}
	...
	\end{split}
\end{equation*}
故由对面积的曲面积分计算公式 \labelcref{equation:线积分与面积分.第一类曲面积分的计算式1} 有\begin{equation*}
...
\begin{solution}
由两类曲面积分之间的联系 \labelcref{equation:线积分与面积分.两类曲面积分之间的联系}，可得\begin{equation*}
