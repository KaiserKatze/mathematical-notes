...
%@see: 《数学分析（第二版 下册）》（陈纪修） P313 性质2（线性性）
设\(\alpha\)、\(\beta\)为常数，
则\begin{equation*}
...
%@see: 《数学分析（第二版 下册）》（陈纪修） P313 性质3（路径可加性）
...
%@see: 《数学分析（第二版 下册）》（陈纪修） P313 性质1（方向性）
设\(L\)是有向光滑曲线弧，
...
\cref{equation:线积分与面积分.第二类曲线积分的计算式1} 可以推广到空间曲线\(\Gamma\)由参数方程\begin{equation*}
	x=\phi(t), \qquad
	y=\psi(t), \qquad
	z=\omega(t)
\end{equation*}给出的情形，
...
\subsection{利用对称性简化第二类曲线积分的计算}
\label{section:线积分与面积分.利用对称性简化第二类曲线积分的计算}
%@see: https://www.bilibili.com/video/BV14J4m1u7Yg/

%平面曲线对坐标曲线积分的奇偶对称性
设平面积分弧段\(L\)关于\(y\)轴（直线\(x=0\)）对称.
\begin{itemize}
