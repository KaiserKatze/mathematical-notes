...
计算曲面积分\(I = \varoiint_\Sigma \frac{x \dd{y}\dd{z} + y \dd{z}\dd{x} + z \dd{x}\dd{y}}{(x^2+y^2+z^2)^{\frac32}}\)，
...
那么由高斯公式可得\begin{equation*}
	\varoiint_{\Sigma+\Sigma'} \frac{x \dd{y}\dd{z} + y \dd{z}\dd{x} + z \dd{x}\dd{y}}{(x^2+y^2+z^2)^{\frac32}}
	= \iiint_\Omega \left( \pdv{P}{x} + \pdv{Q}{y} + \pdv{R}{z} \right) \dd{v}
	= 0,
\end{equation*}
于是\begin{align*}
	I &= -\varoiint_{\Sigma'} \frac{x \dd{y}\dd{z} + y \dd{z}\dd{x} + z \dd{x}\dd{y}}{(x^2+y^2+z^2)^{\frac32}} \\
	&= -\varoiint_{\Sigma'} x \dd{y}\dd{z} + y \dd{z}\dd{x} + z \dd{x}\dd{y} \\
	% 再次运用高斯公式
...
那么\begin{equation*}
	I = \varoiint_{\Sigma + \Sigma'} x \dd{y}\dd{z} + (y^3+2) \dd{z}\dd{x} + z^3 \dd{x}\dd{y}
