...
我们把\cref{theorem:无穷级数.阿贝尔定理推论} 中提到的正数\(R\)
...
\[
\lim_{n\to\infty} \abs{{\frac{[2(n+1)]!}{[(n+1)!]^2} x^{2(n+1)}}\Bigg/{\frac{(2n)!}{(n!)^2} x^{2n}}}
...
\]因为\[
\rho = \lim_{n\to\infty} \abs{\frac{a_{n+1}}{a_n}} = \lim_{n\to\infty} \frac{2^n \cdot n}{2^{n+1} \cdot (n+1)} = \frac{1}{2},
