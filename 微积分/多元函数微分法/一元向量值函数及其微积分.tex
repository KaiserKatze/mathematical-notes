...
\end{align}
\begin{proof}
设\(\vb{u}(t) = (u_1(t),u_2(t),\dotsc,u_n(t))\)，
\(\vb{v}(t) = (v_1(t),v_2(t),\dotsc,v_n(t))\).
那么\[
	\vb{u}(t) \cdot \vb{v}(t)
	= u_1(t) v_1(t) + \dotsb + u_n(t) v_n(t),
\]
于是\begin{align*}
	\dv{t} [\vb{u}(t) \cdot \vb{v}(t)]
	&= [u_1'(t) v_1(t) + u_1(t) v_1'(t)]
		+ \dotsb + [u_n'(t) v_n(t) + u_n(t) v_n'(t)] \\
	&= [u_1'(t) v_1(t) + \dotsb + u_n'(t) v_n(t)]
		+ [u_1(t) v_1'(t) + \dotsb + u_n(t) v_n'(t)] \\
	&= \vb{u}'(t) \cdot \vb{v}(t) + \vb{u}(t) \cdot \vb{v}'(t).
	\qedhere
...
向量\(\vec{OM}=\vb{f}(t_0)\)，\(\vec{ON}=\vb{f}(t_0+t)\).
