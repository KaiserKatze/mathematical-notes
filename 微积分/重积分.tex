...
\Omega = \Set{ (x,y,z) \given z_1(x,y) \leq z \leq z_2(x,y) \land \opair{x,y} \in D_{xy} }.
\]
...
设空间闭区域\[
\Omega = \Set{ (x,y,z) \given c_1 \leq z \leq c_2 \land \opair{x,y} \in D_z },
...
\subsection{引力}
\begin{theorem}
设引力常量为\(G\)，物体占有空间有界闭区域\(\Omega\)，它在点\((x,y,z)\)处的密度为\[
\rho=\rho(x,y,z),
