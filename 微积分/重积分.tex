...
\begin{theorem}
若连续可微函数\[
\mat{y} = f(\mat{x}), \quad (\mat{x},\mat{y} \in \mathbb{R}^n)
...
之前我们讲到，在计算反常积分时，可以直接利用反常积分的定义%
\labelcref{definition:定积分.无穷限的反常积分的定义}、%
\labelcref{definition:定积分.无界函数的反常积分的定义}，%
以及牛顿-莱布尼茨公式\labelcref{theorem:定积分.利用牛顿莱布尼茨公式计算无穷限的反常积分}、%
\labelcref{theorem:定积分.利用牛顿莱布尼茨公式计算无界函数的反常积分}.
