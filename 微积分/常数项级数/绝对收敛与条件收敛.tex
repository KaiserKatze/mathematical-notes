...
判断级数\(\sum_{n=1}^\infty \frac{\sin n\alpha}{n^p}\ (0<\alpha<\pi)\)的敛散性.
\begin{solution}
当\(p>1\)时，由\(\frac{\abs{\sin n\alpha}}{n^p} \leq \frac1{n^p}\)，
可知级数\(\sum_{n=1}^\infty \frac{\sin n\alpha}{n^p}\)绝对收敛.

当\(0<p\leq1\)时，
%@ref: 《数学分析（第二版 下册）》（陈纪修） P34 例9.4.3
易见级数\(\sum_{n=1}^\infty \frac{\sin n\alpha}{n^p}\)收敛，
进而有\[
	\frac{\abs{\sin n\alpha}}{n^p}
	\geq \frac{\sin^2n\alpha}{n^p}
	= \frac1{2n^p} - \frac{\cos2n\alpha}{2n^p},
\]
因为级数\(\sum_{n=1}^\infty \frac1{2n^p}\)发散，
所以级数\(\sum_{n=1}^\infty \frac{\abs{\sin n\alpha}}{n^p}\)发散，
级数\(\sum_{n=1}^\infty \frac{\sin n\alpha}{n^p}\)条件收敛.

当\(p\leq0\)时，由于级数的一般项不趋于0，
级数\(\sum_{n=1}^\infty \frac{\sin n\alpha}{n^p}\)发散.
\end{solution}
\end{example}
