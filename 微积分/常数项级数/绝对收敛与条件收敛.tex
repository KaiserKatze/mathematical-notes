...
\]
且级数\(\sum\limits_{n=1}^\infty a_n^2,\sum\limits_{n=1}^\infty \frac{1}{n^2}\)收敛，
由\hyperref[theorem:无穷级数.收敛级数性质2]{收敛级数的性质}%
及\hyperref[theorem:无穷级数.正项级数的比较审敛法的推论]{正项级数的比较判别法}可知，
