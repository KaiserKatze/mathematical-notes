...
把\(u_n\)称为
“级数\(\sum\limits_{n=1}^\infty u_n\)的\DefineConcept{一般项}”；
把\(\sum\limits_{i=1}^n u_i\)称为
“级数\(\sum\limits_{n=1}^\infty u_n\)的\DefineConcept{部分和}（partial sum）”.

如果级数\(\sum\limits_{n=1}^\infty u_n\)的
部分和\(\sum\limits_{i=1}^n u_i\)
构成的数列收敛于\(s\)，
则称“级数\(\sum\limits_{n=1}^\infty u_n\) \DefineConcept{收敛}（converge）”，
我们把极限\(s\)叫做“级数\(\sum\limits_{n=1}^\infty u_n\)的\DefineConcept{和}（sum）”；
反之，如果这个级数的部分和数列发散，
则称“级数\(\sum\limits_{n=1}^\infty u_n\) \DefineConcept{发散}（diverge）”.
...
我们把常数\(q\)叫做“级数\(\sum\limits_{n=0}^\infty q^n\)的\DefineConcept{公比}”.
试讨论上述等比级数的收敛性.
\begin{solution}
根据\(q\)的取值范围，分情况讨论.
\begin{enumerate}
...
如果级数\(\sum\limits_{n=1}^\infty u_n\)、\(\sum\limits_{n=1}^\infty v_n\)
分别收敛于\(s\)、\(\sigma\)，
则级数\(\sum\limits_{n=1}^\infty(u_n \pm v_n)\)收敛于\(s \pm \sigma\).
\begin{proof}
设级数\(\sum\limits_{n=1}^\infty u_n\)与级数\(\sum\limits_{n=1}^\infty v_n\)的部分和
分别为\(s_n\)与\(\sigma_n\)，
...
\begin{proof}
设级数\(\sum\limits_{n=1}^\infty u_n\)与\(\sum\limits_{n=1}^\infty v_n\)的部分和
分别为\(s_n\)和\(\sigma_n\)，
又设\[
	\lim\limits_{n\to\infty} s_n = s.
\]
假设级数\(\sum\limits_{n=1}^\infty (u_n \pm v_n)\)收敛，
且\[
...
\]
\begin{proof}
设级数\(\sum\limits_{n=1}^\infty u_n\)的部分和为\(s_n\)，
且\(\lim\limits_{n\to\infty} s_n = s\)，
则\[
...
如果\(\lim\limits_{n\to\infty} u_n \neq 0\)，
那么\(\sum\limits_{n=1}^\infty u_n\)一定发散.
例如，级数\[
...
\]是发散的.
\begin{proof}
虽然调和级数的一般项\(\lim\limits_{n\to\infty} u_n
= \lim\limits_{n\to\infty} 1/n
= 0\)，
但是它是发散的.
现在我们用反证法证明.

假设级数\(\sum\limits_{n=1}^\infty u_n\)收敛.
设级数的部分和为\(s_n\)，
且\(\lim\limits_{n\to\infty} s_n
= s\).
显然，对级数\(\sum\limits_{n=1}^\infty u_n\)的部分和\(s_{2n}\)
也有\(\lim\limits_{n\to\infty} s_{2n}
= s\).
于是\[
	\lim\limits_{n\to\infty} {s_{2n}-s_n}
	= \lim\limits_{n\to\infty} s_{2n} - \lim\limits_{n\to\infty} s_n
	= s - s
	= 0.
\]
但另一方面\[
...
使得当\(n>N\)时，
对于任意的正整数\(p\)，
都有\(\abs{ \sum\limits_{i=1}^p u_{n+i} }
< \epsilon\)成立.
\begin{proof}
设级数\(\sum\limits_{n=1}^\infty u_n\)的部分和为
...
对于任意正整数\(p\)，
总有\(\lim\limits_{n\to\infty} \sum\limits_{i=1}^p u_{n+i} = 0\).
\end{proposition}
