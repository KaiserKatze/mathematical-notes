...
求\(\lim_{n\to\infty} \frac1{n^2} \left( \sin\frac1n + 2\frac\frac2n + \dotsb + n\sin\frac{n}{n} \right)\).
\begin{solution}
直接计算得\begin{align*}
	&\lim_{n\to\infty} \frac1{n^2} \left( \sin\frac1n + 2\frac\frac2n + \dotsb + n\sin\frac{n}{n} \right) \\
