...
在变换为极坐标\(x = \rho \cos\theta, y = \rho \sin\theta\)的特殊情形下，
雅克比式\[
...
那么\begin{align*}
	...
	&= \iint_G e^{\frac{u}{v}} \abs{-\frac12} \dd{u} \dd{v} \\
	&= \frac12 \int_0^2 \dd{v} \int_{-v}^v e^{\frac{u}{v}} \dd{u} \\
...
\]
在这变换下，与\(D\)对应的闭区域为
\(G = \Set{\opair{\rho,\theta} \given 0\leq\rho\leq1,0\leq\theta\leq2\pi}\)，
雅克比式\[
