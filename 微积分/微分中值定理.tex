...
\begin{theorem}[达布定理]\label{theorem:微分中值定理.达布定理}
设函数\(f \in D(a,b)\).
...
成立.
\end{theorem}
\cref{equation:微分中值定理.拉格朗日中值公式} 叫做\textbf{拉格朗日中值公式}.
...
因此，这个定理也叫做\textbf{有限增量定理}，\cref{equation:微分中值定理.有限增量公式} 称为\textbf{有限增量公式}.
