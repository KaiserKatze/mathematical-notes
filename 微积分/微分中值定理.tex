...
\labelcref{equation:微分中值定理.泰勒公式.多项式1} 以及辅助函数(1)，
...
如果\(f'(x_0)=0\)，
则称“\((x_0,f(x_0))\)是\(f\)的\DefineConcept{驻点}”.
\end{definition}
...
如果\[
	...
	\right],
\]
那么称“\(f(x_0)\)是函数\(f\)的一个\DefineConcept{极大值}”.
...
如果\[
	...
	\right],
\]
那么称“\(f(x_0)\)是函数\(f\)的一个\DefineConcept{极小值}”.

函数的极大值与极小值统称为函数的\DefineConcept{极值}.
使函数取得极值的点称为\DefineConcept{极值点}.
\end{definition}
