...
如果级数\(\sum\limits_{n=1}^\infty u_n\)绝对收敛，则级数\(\sum\limits_{n=1}^\infty v_n\)和\(\s w_i\)都收敛；如果级数\(\sum\limits_{n=1}^\infty u_n\)条件收敛，则级数\(\sum\limits_{n=1}^\infty v_n\)和\(\s w_i\)都发散.
