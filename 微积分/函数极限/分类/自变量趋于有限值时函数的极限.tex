...
那么称
“函数\(f\)在点\(x_0\)是\DefineConcept{收敛的}”
“函数\(f\)在点\(x_0\) \DefineConcept{收敛}”
“函数\(f\)在点\(x_0\)的极限存在且有限”
“极限\(\lim_{x \to x_0} f(x)\)存在且有限”
“常数\(A\)是函数\(f\)当\(x \to x_0\)时的\DefineConcept{极限}”
“函数\(f\)在点\(x_0\)的\DefineConcept{极限}是\(A\)”
“函数\(f\)当\(x \to x_0\)时\DefineConcept{收敛于} \(A\)”，
记作\begin{equation*}
	\lim_{D \ni x \to x_0} f(x) = A,
	\quad\text{或}\quad
