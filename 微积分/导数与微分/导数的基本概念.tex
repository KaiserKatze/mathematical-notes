...
\begin{itemize}
	...
	\end{equation*}称为“函数\(f\)在点\(x_0\)的\DefineConcept{右上导数}（upper right Dini derivative）”.
	\item 把\begin{equation*}
		\lim_{\delta\to0^+} \inf_{0<x-x_0<\delta} f(x)
	\end{equation*}称为“函数\(f\)在点\(x_0\)的\DefineConcept{右下导数}（lower right Dini derivative）”.
	\item 把\begin{equation*}
		\lim_{\delta\to0^+} \sup_{-\delta<x-x_0<0} f(x)
	\end{equation*}称为“函数\(f\)在点\(x_0\)的\DefineConcept{左上导数}（upper left Dini derivative）”.
	\item 把\begin{equation*}
		\lim_{\delta\to0^+} \inf_{-\delta<x-x_0<0} f(x)
	\end{equation*}称为“函数\(f\)在点\(x_0\)的\DefineConcept{左下导数}（lower left Dini derivative）”.
\end{itemize}
...
\end{equation*}称为“函数\(f\)的\DefineConcept{导函数}（derivative function）”，
简称\DefineConcept{导数}，
...
\subsection{导数的几何意义}
曲线\(y=f(x)\)在点\(M(x_0,y_0)\)处的\DefineConcept{切线方程}为\begin{equation*}
	y-y_0=f'(x_0)(x-x_0).
\end{equation*}
...
\begin{example}
\DefineConcept{魏尔斯特拉斯函数}\begin{equation*}
...
%@see: 《2025年全国硕士研究生入学统一考试（数学一）》一选择题/第3题/选项(A)
...
\end{example}
\begin{example}
%@see: 《2025年全国硕士研究生入学统一考试（数学一）》一选择题/第3题/选项(B)
...
\end{example}
\begin{example}
%@see: 《2025年全国硕士研究生入学统一考试（数学一）》一选择题/第3题/选项(C)
举例说明：可导函数\(f\)满足\(\lim_{x\to+\infty} \frac1x \int_0^x f(t) \dd{t} < \infty\)，
但是极限\(\lim_{x\to+\infty} f(x)\)不存在.
\begin{solution}
%@credit: {cee35532-e299-4587-89a0-7b84e7454774},{6c2d2bed-2bb7-4528-8695-7d56476f78b7},{9f1195dd-07a4-40f8-b83e-4b1f2dd2a3cf}
取\(f(x) = \cos x\)，
