\section{可分离变量的微分方程}
我们首先讨论一阶微分方程\begin{equation}\label{equation:微分方程.一阶微分方程的一般形式}
%@see: 《高等数学（第六版 上册）》 P299 (1)
	y' = f(x,y)
\end{equation}的一些解法.

一阶微分方程 \labelcref{equation:微分方程.一阶微分方程的一般形式} 有时也写成如下的
对称形式\begin{equation}\label{equation:微分方程.一阶微分方程的对称形式}
%@see: 《高等数学（第六版 上册）》 P299 (2)
	P(x,y) \dd{x} + Q(x,y) \dd{y} = 0.
\end{equation}
在微分方程 \labelcref{equation:微分方程.一阶微分方程的对称形式} 中，
变量\(x\)与\(y\)对称，
...
\begin{definition}
如果一阶微分方程 \labelcref{equation:微分方程.一阶微分方程的一般形式}
能化成\begin{equation}\label{equation:微分方程.一阶微分方程的分离变量形式}
%@see: 《高等数学（第六版 上册）》 P300 (5)
	g(y) \dd{y} = f(x) \dd{x}
\end{equation}的形式，
那么称“一阶微分方程 \labelcref{equation:微分方程.一阶微分方程的一般形式}
是一个\DefineConcept{可分离变量的微分方程}”.
\end{definition}

假定一阶微分方程 \labelcref{equation:微分方程.一阶微分方程的分离变量形式} 中的函数\(g(y)\)和\(f(x)\)是连续的.
设\(y=\phi(x)\)是一阶微分方程 \labelcref{equation:微分方程.一阶微分方程的分离变量形式} 的解，
将它代入一阶微分方程 \labelcref{equation:微分方程.一阶微分方程的分离变量形式} 中得到恒等式\begin{equation*}
...
%@see: 《高等数学（第六版 上册）》 P300 (6)
	G(y) = F(x) + C.
\end{equation}
因此一阶微分方程 \labelcref{equation:微分方程.一阶微分方程的分离变量形式} 的解
满足\cref{equation:微分方程.一阶微分方程的分离变量形式.隐式解} .
反之，如果\(y = \Phi(x)\)是
由\cref{equation:微分方程.一阶微分方程的分离变量形式.隐式解} 所确定的隐函数，
那么在\(g(y)\neq0\)的条件下，
\(y=\Phi(x)\)也是一阶微分方程 \labelcref{equation:微分方程.一阶微分方程的分离变量形式} 的解，
事实上，由\hyperref[theorem:多元函数微分法.隐函数存在定理1]{隐函数的求导法}可知，
当\(g(y)\neq0\)时，\begin{equation*}
	\Phi'(x) = \frac{F'(x)}{G'(y)} = \frac{f(x)}{g(y)},
\end{equation*}
这就表示函数\(y = \Phi(x)\)满足一阶微分方程 \labelcref{equation:微分方程.一阶微分方程的分离变量形式}.
所以，如果已分离变量的一阶微分方程 \labelcref{equation:微分方程.一阶微分方程的分离变量形式} 中，
\(g(y)\)和\(f(x)\)是连续的，且\(g(y)\neq0\)，
那么一阶微分方程 \labelcref{equation:微分方程.一阶微分方程的分离变量形式}
两端积分后得到的\cref{equation:微分方程.一阶微分方程的分离变量形式.隐式解} ，
就用隐式给出了一阶微分方程 \labelcref{equation:微分方程.一阶微分方程的分离变量形式} 的解，
\cref{equation:微分方程.一阶微分方程的分离变量形式.隐式解} 就叫做
“一阶微分方程 \labelcref{equation:微分方程.一阶微分方程的分离变量形式} 的\DefineConcept{隐式解}”.
又由于\cref{equation:微分方程.一阶微分方程的分离变量形式.隐式解} 中含有任意常数，
因此\cref{equation:微分方程.一阶微分方程的分离变量形式.隐式解} 所确定的隐函数
是一阶微分方程 \labelcref{equation:微分方程.一阶微分方程的分离变量形式} 的通解，
所以\cref{equation:微分方程.一阶微分方程的分离变量形式.隐式解} 叫做
“一阶微分方程 \labelcref{equation:微分方程.一阶微分方程的分离变量形式} 的\DefineConcept{隐式通解}”.
当\(f(x)\neq0\)时，\cref{equation:微分方程.一阶微分方程的分离变量形式.隐式解}
所确定的隐函数\(x=\Psi(y)\)也可认为是一阶微分方程 \labelcref{equation:微分方程.一阶微分方程的分离变量形式} 的解.
...
\section{齐次方程}
有的一阶线性齐次微分方程可以化成\begin{equation}\label{equation:微分方程.一阶齐次方程}
%@see: 《高等数学（第六版 上册）》 P305 (1)
	\dv{y}{x}=\phi\left(\frac{y}{x}\right)
\end{equation}的形式.

在解这类方程的时候，我们可以使用换元法，
在方程中引入新的未知函数\begin{equation}\label{equation:微分方程.一阶齐次方程.中间步骤1}
%@see: 《高等数学（第六版 上册）》 P305 (2)
	u=\frac{y}{x},
\end{equation}
就可以将其化为可分离变量的方程.
这是因为由微分方程 \labelcref{equation:微分方程.一阶齐次方程.中间步骤1} 有\begin{equation*}
	y = ux,
	\qquad
	\dv{y}{x} = u + x \dv{u}{x},
\end{equation*}
代入微分方程 \labelcref{equation:微分方程.一阶齐次方程}，便得方程\begin{equation*}
	u + x \dv{u}{x} = \phi(u),
\end{equation*}
即\begin{equation*}
	x \dv{u}{x} = \phi(u) - u.
...
\section{可化为齐次的微分方程}
方程\begin{equation}\label{equation:微分方程.可化为齐次的方程}
...
即\begin{equation*}
	...
	\end{vmatrix}},
\end{equation*}
从而将微分方程 \labelcref{equation:微分方程.可化为齐次的方程}
...
便得微分方程 \labelcref{equation:微分方程.可化为齐次的方程} 的通解.
...
\end{equation*}
于是微分方程 \labelcref{equation:微分方程.可化为齐次的方程} 成为可分离变量的微分方程\begin{equation*}
...
对于一阶线性非齐次微分方程\begin{equation}\label{equation:微分方程.一阶线性非齐次微分方程}
...
首先，我们把\(Q(x)\)换成零，
写出方程\begin{equation}\label{equation:微分方程.一阶线性齐次微分方程}
%@see: 《高等数学（第六版 上册）》 P310 (2)
	\dv{y}{x} + P(x) y = 0.
\end{equation}
一阶线性齐次微分方程 \labelcref{equation:微分方程.一阶线性齐次微分方程}
叫做“对应于一阶线性非齐次微分方程 \labelcref{equation:微分方程.一阶线性非齐次微分方程} 的线性齐次方程”.

一阶线性齐次微分方程 \labelcref{equation:微分方程.一阶线性齐次微分方程} 是可分离变量的，分离变量后得\begin{equation*}
...
或\begin{equation*}
	...
	\quad(C = \pm e^{C_1}),
\end{equation*}
这是一阶线性齐次微分方程 \labelcref{equation:微分方程.一阶线性齐次微分方程} 的通解
\footnote{
	这里记号\(\int P(x) \dd{x}\)表示\(P(x)\)的某个确定的原函数.
}.

现在我们使用所谓“常数变易法”来求一阶线性非齐次微分方程 \labelcref{equation:微分方程.一阶线性非齐次微分方程} 的通解.
这方法是把一阶线性齐次微分方程 \labelcref{equation:微分方程.一阶线性齐次微分方程} 的通解中的\(C\)换成\(x\)的未知函数\(u(x)\)，
...
代入一阶线性非齐次微分方程 \labelcref{equation:微分方程.一阶线性非齐次微分方程}
得\begin{equation*}
...
便得一阶线性非齐次微分方程 \labelcref{equation:微分方程.一阶线性非齐次微分方程} 的通解\begin{equation}\label{equation:微分方程.一阶线性非齐次微分方程的通解}
	y = e^{ -\int P(x) \dd{x} } \left( \int Q(x) e^{ \int P(x) \dd{x} } \dd{x} + C \right).
\end{equation}
上式右端第一项是一阶线性齐次微分方程 \labelcref{equation:微分方程.一阶线性齐次微分方程} 的通解，
第二项是一阶线性非齐次微分方程 \labelcref{equation:微分方程.一阶线性非齐次微分方程} 的一个特解.
...
\section{伯努利方程}
方程\begin{equation}\label{equation:微分方程.伯努利方程}
%@see: 《高等数学（第六版 上册）》 P314 (10)
	\dv{y}{x} + P(x) y = Q(x) y^n
\end{equation}
叫做\DefineConcept{伯努利方程}.
当\(n=0\)或\(n=1\)时，
伯努利方程 \labelcref{equation:微分方程.伯努利方程} 就是一阶线性微分方程，
可以直接按\cref{section:微分方程.一阶线性微分方程}讲述的步骤解出该方程.
当\(n\neq0,1\)时，这方程不是线性的，
但是通过变量的代换，可以把它化为线性的.
事实上，以\(y^n\)除伯努利方程 \labelcref{equation:微分方程.伯努利方程} 两端，
得\begin{equation}\label{equation:微分方程.伯努利方程.中间步骤}
...
\end{equation*}
用\((1-n)\)乘微分方程 \labelcref{equation:微分方程.伯努利方程.中间步骤} 的两端，
再通过上述代换便得一阶线性微分方程\begin{equation}\label{equation:微分方程.伯努利方程.换元后得到的方程}
	\dv{z}{x} + (1-n) P(x) z = (1-n) Q(x).
\end{equation}
求出微分方程 \labelcref{equation:微分方程.伯努利方程.换元后得到的方程} 的通解后，
以\(y^{1-n}\)代\(z\)便得到伯努利方程的通解.

特别地，当\(n>0\)时，\(y\)可以取为\(0\)，
而\(y=0\)恰好也满足伯努利方程 \labelcref{equation:微分方程.伯努利方程} .
