...
以二阶微分方程\begin{equation}\label{equation:微分方程.二阶微分方程.1111型}
	y'' = f(x,y,y')
\end{equation}而论，
如果我们能设法作代换把它从二阶降为一阶，
...
微分方程\begin{equation}\label{equation:微分方程.简单高阶微分方程}
	y^{(n)} = f(x)
\end{equation}的右端仅含有自变量\(x\).
容易看出，只要把\(y^{(n-1)}\)作为新的未知函数，
那么微分方程 \labelcref{equation:微分方程.简单高阶微分方程} 就是新未知函数的一阶微分方程.
...
\end{equation*}
依此法继续进行，接连积分\(n\)次，
便得微分方程 \labelcref{equation:微分方程.简单高阶微分方程} 的含有\(n\)个任意常数的通解.
...
微分方程\begin{equation}\label{equation:微分方程.二阶微分方程.1011型}
	y'' = f(x, y')
\end{equation}的右端不显含未知函数\(y\).
如果设\(y' = p\)，那么\begin{equation*}
	y'' = \dv[2]{y}{x} = \dv{p}{x} = p',
\end{equation*}
而微分方程 \labelcref{equation:微分方程.二阶微分方程.1011型} 就成为\begin{equation*}
	p' = f(x, p),
\end{equation*}
...
但是\(p = \dv{y}{x}\)，因此又得到一个一阶微分方程\begin{equation*}
	\dv{y}{x} = \phi(x, C_1).
\end{equation*}
对它进行积分，便得微分方程 \labelcref{equation:微分方程.二阶微分方程.1011型} 的
...
方程\begin{equation}\label{equation:微分方程.二阶微分方程.0111型}
	y'' = f(y, y')
\end{equation}
中不显含自变量\(x\).
...
\end{equation*}
这样，微分方程 \labelcref{equation:微分方程.二阶微分方程.0111型} 就成为\begin{equation*}
	p~\dv{p}{y} = f(y, p).
\end{equation*}
...
设它的通解为\begin{equation*}
	y' = p = \phi(y, C_1),
\end{equation*}
分离变量并积分，便得微分方程 \labelcref{equation:微分方程.二阶微分方程.0111型} 的
