...
% %TODO
% %@Mathematica: Limit[Power[n!, (n)^-1]/n, n -> Infinity]
% \end{example}

% \begin{example}
% 求极限\(\lim_{n\to\infty} \frac{n!}{(a+1)(a+2)\dotsm(a+n)}\ (a>0)\).
% %TODO
% %@Mathematica: Assuming[a > 0, Limit[n!/Product[a + k, {k, 1, n}], n -> Infinity]]
% \end{example}
