...
如果微分方程中的未知函数是一元函数\(y = y(x)\)，
则称其为\textbf{常微分方程}（ordinary differential equation）.

如果微分方程中的未知函数是多元函数\(y = y(\v{x}{m})\)，
则称其为\textbf{偏微分方程}（partial differential equation）.

微分方程中所出现的未知函数的最高阶导数（或偏导数）的阶数，
