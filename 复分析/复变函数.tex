...
\begin{enumerate}
	...
	\item \(\lim_{n\to\infty} x_n = x_0 \land \lim_{n\to\infty} y_n = y_0\)，
	其中\begin{gather*}
...
\item\label{theorem:复变函数.连续函数的性质.3a}
\(f(z)\)在\(E\)上有界，
即\begin{equation*}
\exists M>0 \bigl[
