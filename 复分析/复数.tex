...
设非零复数\(z_1 = r_1 e^{\iu \theta_1}\)、\(z_2 = r_2 e^{\iu \theta_2}\)，
则\begin{gather*}
	z_1 z_2
	= r_1 e^{\iu \theta_1} \cdot r_2 e^{\iu \theta_2}
	= r_1 r_2 e^{\iu(\theta_1+\theta_2)}, \\
	\frac{z_1}{z_2}
	= \frac{r_1 e^{\iu \theta_1}}{r_2 e^{\iu \theta_2}}
	= \frac{r_1}{r_2} e^{\iu(\theta_1-\theta_2)}
\end{gather*}
\end{theorem}
