...
\begin{enumerate}
	...
	\defiff
	(\varphi\iff(\neg\psi))\).
	\item \((\varphi\land\psi\lor\eta)
	\defiff
	((\varphi\land\psi)\lor\eta)\).
	\item \((\varphi\lor\psi\land\eta)
	\defiff
	(\varphi\lor(\psi\land\eta))\).
	\item \((\varphi\land\psi\implies\eta)
	\defiff
	((\varphi\land\psi)\implies\eta)\).
	\item \((\varphi\implies\psi\land\eta)
	\defiff
	(\varphi\implies(\psi\land\eta))\).
	\item \((\varphi\land\psi\iff\eta)
	\defiff
	((\varphi\land\psi)\iff\eta)\).
	\item \((\varphi\iff\psi\land\eta)
	\defiff
	(\varphi\iff(\psi\land\eta))\).
	\item \((\varphi\lor\psi\implies\eta)
	\defiff
	((\varphi\lor\psi)\implies\eta)\).
	\item \((\varphi\implies\psi\lor\eta)
	\defiff
	(\varphi\implies(\psi\lor\eta))\).
	\item \((\varphi\lor\psi\iff\eta)
	\defiff
	((\varphi\lor\psi)\iff\eta)\).
	\item \((\varphi\iff\psi\lor\eta)
	\defiff
	(\varphi\iff(\psi\lor\eta))\).
	\item \((\varphi\implies\psi\iff\eta)
	\defiff
	((\varphi\implies\psi)\iff\eta)\).
	\item \((\varphi\iff\psi\implies\eta)
	\defiff
	(\varphi\iff(\psi\implies\eta))\).
\end{enumerate}
\end{definition}
非形式地说，逻辑联结词的优先级为：\[
	\neg, \qquad
