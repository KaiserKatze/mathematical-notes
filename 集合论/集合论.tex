...
\begin{itemize}
	...
	则称“关系\(\rel{R}\)是集合\(A\)上的\textbf{等价关系}（equivalence）”.

	\item 如果关系\(\rel{R}\)同时具有自反性、反对称性、传递性，
	则称“关系\(\rel{R}\)是集合\(A\)上的\textbf{偏序关系}（partial ordering）”.
\end{itemize}
\end{definition}
...
\]称作“关系\(\rel{R}\)的\textbf{定义域}（domain）”，记作\(\dom \rel{R}\).

把集合\[
	\Set{ y \given \opair{x,y} \in \rel{R} }
\]称作“关系\(\rel{R}\)的\textbf{值域}（range）”，记作\(\ran \rel{R}\).

把集合\[
	\dom \rel{R} \cup \ran \rel{R}
\]称作“关系\(\rel{R}\)的\textbf{域}（field）”，记作\(\fld \rel{R}\).
\end{definition}
