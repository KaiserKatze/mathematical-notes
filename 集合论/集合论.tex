...
如果\[
	m \in n \lor m = n,
\]
则称“\(m\)\DefineConcept{小于或等于}\(n\)”（记作\(m \leqslant n\)），
或称“\(n\)\DefineConcept{大于或等于}\(m\)”（记作\(n \geqslant m\)），
即\[
	m \in n \lor m = n
	\iff m \leqslant n
	\iff n \geqslant m.
...
\begin{theorem}\label{theorem:集合论.自然数的加法的保序性}
...
\]
\begin{proof}%theorem:集合论.有序对的性质1
...
\begin{theorem}
%@see: 《Elements of Set Theory》 P94. Lemma 5ZC
%@see: 《Elements of Set Theory》 P95. Lemma 5ZD
以下命题恒成立：
\begin{enumerate}
	\item 加法交换律\[
...
\end{proof}
\end{theorem}
这个定理说明整数集\(\mathbb{Z}\)配上加法运算就成为一个阿贝尔群！
