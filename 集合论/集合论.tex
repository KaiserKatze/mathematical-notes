...
\]为“\(A\)和\(B\)的\DefineConcept{并}（the union of \(A\) and \(B\)）”，%
记作\(A \cup B\)或\(A+B\).
\end{definition}
...
\end{enumerate}
\begin{proof}
对\cref{equation:集合论.集合代数公式1} 证明如下：
\begin{align*}
	x \in A \cap B
...
对\cref{equation:集合论.集合代数公式2} 证明如下：
\begin{align*}
	x \in A \cup B
...
对\cref{equation:集合论.集合代数公式3} 证明如下：
\begin{align*}
	x \in (A \cap B) \cap C
...
对\cref{equation:集合论.集合代数公式4} 证明如下：
\begin{align*}
	x \in (A \cup B) \cup C
