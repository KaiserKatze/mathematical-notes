...
\begin{example}
%@see: 《实变函数论（第三版）》（周民强） P19 例8
设\(\{r_n\}\)是全体正有理数的一个排列：\begin{equation*}
	1,
	\frac12,
	2,
	3,
...
\begin{example}
%@see: 《实变函数论（第三版）》（周民强） P20 例12 (i)
设\(f\)是定义在\(\mathbb{R}\)上的实值函数，
则点集\begin{equation*}
	E
	\defeq
	\Set{
...
\begin{example}
%@see: 《实变函数论（第三版）》（周民强） P20 例12 (ii)
设\(f\)是定义在\(\mathbb{R}\)上的实值函数，
则点集\begin{equation*}
	\Set{
		x \in \mathbb{R}
		\given
		\text{$f$在点$x$不连续，但右极限$f(x^+)$存在}
	}
\end{equation*}
是可数集.
\end{example}
