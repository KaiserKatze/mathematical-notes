...
\begin{itemize}
	\item 若\[
		...
		[x\rel{R}x],
	\]
	则称“关系\(\rel{R}\)具有\DefineConcept{自反性}（\(R\) is \emph{reflexive}）”；

	\item 若\[
		(\forall x,y \in A)
		[x\rel{R}y \implies y\rel{R}x],
	\]
	则称“关系\(\rel{R}\)具有\DefineConcept{对称性}（\(R\) is \emph{symmetric}）”；

	\item 若\[
		(\forall x,y,z \in A)
		[x\rel{R}y \land y\rel{R}z \implies x\rel{R}z],
	\]
	则称“关系\(\rel{R}\)具有\DefineConcept{传递性}（\(R\) is \emph{transitive}）”.
\end{itemize}
\end{definition}
...
证明：\begin{enumerate}
	...
	\item \(\rel{R}\)同时具有对称性和传递性的充分必要条件是\(\rel{R} = \rel{R}^{-1}\circ\rel{R}\).
\end{enumerate}
%TODO
\end{example}
