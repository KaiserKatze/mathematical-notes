...
\begin{gather}
	...
	A \subseteq C, B \subseteq C \iff A \cup B \subseteq C, \label{equation:集合论.集合代数公式6-8} \\
	A \subseteq B, A \subseteq C \iff A \subseteq B \cap C, \label{equation:集合论.集合代数公式6-9} \\
...
对\cref{equation:集合论.集合代数公式6-9} 证明如下：
\begin{align*}
	A \subseteq B, A \subseteq C
	&\iff (\forall x)[x \in A \limp x \in B] \land (\forall x)[x \in A \limp x \in C] \\
	% 量词分配律
	&\iff (\forall x)[(x \in A \limp x \in B) \land (x \in A \limp x \in C)] \\
	&\iff (\forall x)[x \in A \limp (x \in B \land x \in C)] \\
	&\iff (\forall x)[x \in A \limp x \in B \cap C] \\
