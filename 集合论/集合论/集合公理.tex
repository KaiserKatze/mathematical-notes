...
记作\begin{equation*}
	...
	~\footnote{
		读作“\(B\)真包含\(A\)
		（\(B\) properly includes \(A\)）”.
	}
	\footnote{
		在有的书上，作者会用\(\subset\)和\(\supset\)分别代替\(\subseteq\)和\(\supseteq\)，表示子集.
		在有的书上，作者会用\(\subsetneq\)和\(\supsetneq\)分别代替\(\subset\)和\(\supset\)，表示真子集.
		在有的书上，作者会用\(\subsetneqq\)和\(\supsetneqq\)分别代替\(\subset\)和\(\supset\)，表示真子集.
		% 《点集拓扑讲义（第四版）》（熊金城）用\(\subset,\supset\)表示包含关系，用\(\subsetneqq,\supsetneqq\)表示真包含关系.
		% 《Topology (Second Edition)》（James R. Munkres）用\(\subset,\supset\)表示包含关系，用\(\subsetneq,\supsetneq\)表示真包含关系.
	},
\end{equation*}
即\begin{equation*}
	A \subseteq B
