...
\]且对\(x\in\mathbb{R}\)，极限\[
\lim\limits_{\varepsilon\to0^+} P(X \leq x \vert y - \varepsilon < Y \leq y + \varepsilon)
\]存在，%
...
&= \l \frac{P(X \leq x, y - \varepsilon < Y \leq y + \varepsilon)}{P(y - \varepsilon < Y \leq y + \varepsilon)} \\
