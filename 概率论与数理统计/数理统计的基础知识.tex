...
\section{总体与样本}
\begin{definition}
在数理统计中，我们称全体被研究的对象为\DefineConcept{总体}，每个研究对象是一个\DefineConcept{个体}.
如果总体中个体数是有限的，那么称这个总体为\DefineConcept{有限总体}；反之，称这个总体为\DefineConcept{无限总体}.
\end{definition}
...
\begin{definition}
设随机变量\(\AutoTuple{X}{n}\)与总体\(X\)独立同分布，则称“\(\AutoTuple{X}{n}\)为一样本容量为\(n\)的来自总体\(X\)的\DefineConcept{（简单随机）样本}”.
