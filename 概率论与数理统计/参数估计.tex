...
\quad \overline{Y} = \frac{1}{n_2} \sum\limits_{i=1}^{n_2}{Y_i},
\]\[
S_1^2 = \frac{1}{n_1-1} \sum\limits_{i=1}^{n_1}{(X_i-\overline{X})^2}, \quad S_2^2 = \frac{1}{n_2-1} \sum\limits_{i=1}^{n_2}{(Y_i-\overline{Y})^2}.
\]
