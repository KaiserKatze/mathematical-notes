...
过原点，且分别以\(\mat{d}_1,\mat{d}_2,\mat{d}_3\)为方向的有向直线分别称为\(x\)轴、\(y\)轴、\(z\)轴，
统称为\textbf{坐标轴}.
...
为“\(\mat{a}\)与\(\mat{b}\)的\textbf{内积}”，记作\(\mat{a} \cdot \mat{b}\)，即
\begin{equation}
	\mat{a} \cdot \mat{b}
	\defeq
...
若\(\mat{b}\neq\mat{0}\)，则有\begin{equation}
	\mat{a}\cdot\mat{b}
	= (\mat{a})_{\mat{b}} \abs{\mat{b}}.
\end{equation}
这表明了向量的内积与分量的关系.

由向量内积的定义式可得\begin{gather}
...
由上可知，\(\mat{a}\)的方向余弦就是与\(\mat{a}\)同向的单位向量\(\mat{a}^0\)的直角坐标，从而有\[
...
则称\(\mat{c}\)为“\(\mat{a}\)与\(\mat{b}\)的\textbf{外积}”，
记作\(\mat{a}\times\mat{b}\).
