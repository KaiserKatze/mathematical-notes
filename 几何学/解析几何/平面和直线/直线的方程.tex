...
\begin{equation}\label{equation:解析几何.直线的向量式参数方程}
	\vb{r} = \vb{r}_0 + t \vb{\nu}.
\end{equation}
\cref{equation:解析几何.直线的向量式参数方程}
称为“（仿射标架\([O;\vb{d}_1,\vb{d}_2,\vb{d}_3]\)中）直线\(l\)的\DefineConcept{向量式参数方程}”，
其中\(t\)是实参数.
我们可以这样考虑参数\(t\)的几何意义：
...
\begin{equation}\label{equation:解析几何.直线的参数方程}
	...
	\end{array} \right.
\end{equation}
\cref{equation:解析几何.直线的参数方程}
称为“（仿射标架\([O;\vb{d}_1,\vb{d}_2,\vb{d}_3]\)中）直线\(l\)的\DefineConcept{参数方程}”，
其中\(t\)是实参数.
...
于是，
若\(X,Y\neq0\)，\(Z=0\)，则有
\begin{equation}\label{equation:解析几何.直线的点向式方程1}
	\left\{ \begin{array}{l}
		\frac{x - x_0}{X}
		= \frac{y - y_0}{Y}, \\
		z - z_0 = 0;
...
\end{equation}
若\(Y,Z\neq0\)，\(X=0\)，则有
\begin{equation}\label{equation:解析几何.直线的点向式方程2}
	\left\{ \begin{array}{l}
		\frac{y - y_0}{Y}
		= \frac{z - z_0}{Z}, \\
		x - x_0 = 0;
...
\end{equation}
若\(Z,X\neq0\)，\(Y=0\)，则有
\begin{equation}\label{equation:解析几何.直线的点向式方程3}
	\left\{ \begin{array}{l}
		\frac{x - x_0}{X}
		= \frac{z - z_0}{Z}, \\
		y - y_0 = 0;
...
\end{equation}
若\(X,Y,Z\neq0\)，则有
\begin{equation}\label{equation:解析几何.直线的点向式方程4}
	\frac{x - x_0}{X}
	= \frac{y - y_0}{Y}
	= \frac{z - z_0}{Z}.
\end{equation}
\cref{equation:解析几何.直线的点向式方程1,equation:解析几何.直线的点向式方程2,equation:解析几何.直线的点向式方程3,equation:解析几何.直线的点向式方程4}
统称为“（仿射标架\([O;\vb{d}_1,\vb{d}_2,\vb{d}_3]\)中）直线\(l\)的\DefineConcept{点向式方程}”
“（仿射标架\([O;\vb{d}_1,\vb{d}_2,\vb{d}_3]\)中）直线\(l\)的\DefineConcept{对称式方程}”
或“（仿射标架\([O;\vb{d}_1,\vb{d}_2,\vb{d}_3]\)中）直线\(l\)的\DefineConcept{标准方程}”.
它实际上是联立两个方程而得的方程组.
...
称为“（仿射标架\([O;\vb{d}_1,\vb{d}_2,\vb{d}_3]\)中）直线\(l\)的\DefineConcept{两点式方程}”.
...
\end{equation}
就是直线\(l\)的方程，
称为“（仿射标架\([O;\vb{d}_1,\vb{d}_2,\vb{d}_3]\)中）直线\(l\)的\DefineConcept{一般方程}”.
% 显然，如果我们考虑的是直线\(l\)在给定平面仿射标架\([O;\vb{d}_1,\vb{d}_2]\)上的方程，
% 那么相当于考虑一个平面\(A_1 x + B_1 y + C_1 z + D_1 = 0\)与平面\(z = 0\)的交线，
% 直线\(l\)的方程就是\(A_1 x + B_1 y + D_1 = 0\).
