\section{二次曲线方程的对称中心}\label{section:解析几何.二次曲线方程的对称中心}
...
\subsection{直线与二次曲线的相关位置}\label{section:解析几何.直线与二次曲线的相关位置}
...
把线段\(M_1 M_2\)称为“\(S\)的一条\DefineConcept{弦}”.
\end{definition}

\begin{lemma}\label{theorem:二次曲线方程的对称中心.弦中点方程}
