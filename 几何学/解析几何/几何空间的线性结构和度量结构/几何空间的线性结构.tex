...
所以\(
	\vec{OD}
	= \vec{CD} - \vec{CO}
	% = \left( 1 - \frac{(1+\lambda)\mu}{1+(1+\lambda)\mu} \right) \vec{CD}
...
于是\begin{equation*}
	\vec{CO}
	% = \frac{(1+\lambda)\mu}{1+(1+\lambda)\mu}
	% 	\left( \frac{1}{1+\lambda} \vec{CA} + \frac{\lambda}{1+\lambda} y \vec{CE} \right)
...
代入上式得\begin{equation*}
	\vec{CO}
	% = \frac{\mu}{1+(1+\lambda)\mu} \vec{CA}
	% + \frac{\lambda\mu}{1+(1+\lambda)\mu} \left( 1 + \frac{1}{\lambda\mu} \right) \vec{CE}
	= \frac{\mu}{1+(1+\lambda)\mu} \vec{CA}
...
% \(\frac{\vec{AO}}{\vec{OE}} = \frac{\vec{AO}}{\vec{OA}+\vec{AE}} = \frac{\vec{AO}}{t\vec{AO}-\vec{AO}} = \frac{1}{t-1}\)
那么\(O\)分\(AE\)成定比\(
	% \frac{1}{\frac{1+(1+\lambda)\mu}{1+\lambda\mu} - 1}
	% =
	\frac{1+\lambda\mu}{\mu}
\).
\end{proof}
