...
相对地，为了以示区别，我们将原有的、不是无穷远直线的那些直线称为\DefineConcept{通常直线}.
今后我们把通常直线和无穷远直线统称为\DefineConcept{直线}.
...
点\(M(\AutoTuple{x}{3})\)在直线\(AB\)上的充分必要条件是
...
称为“直线\(AB\)的\DefineConcept{齐次坐标参数方程}”.
