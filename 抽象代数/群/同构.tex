...
因为\(\sigma\)是\(M\)的恒等映射，即\begin{equation*}
...
因为对于任意\(a\in G\)，总有\begin{equation*}
...
因为对于任意\(a,b\in G\)，总有\begin{equation*}
...
\begin{proof}
设\(G\)是非空集合，
\(\times\)是定义在\(G\)上的一个二元代数运算，\begin{equation*}
	S = \Set{ \sigma \given \text{\(\sigma\)是\(\opair{G,\times}\)的自同构} }.
\end{equation*}
由\cref{example:抽象代数.恒等映射是自同构}，
恒等同构\(i\)是\(\opair{S,\circ}\)的单位元，即对于任意映射\(\sigma\)，有\begin{equation*}
...
两个内同构的复合也是内同构.
\begin{proof}
设\(\opair{G,\times}\)是群，\(a,b\in G\)，那么映射\begin{equation*}
